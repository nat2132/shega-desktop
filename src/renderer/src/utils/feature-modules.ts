...
export const MODULE_META: ModuleMeta[] = [
  ...
  { id: 'analytics', iconName: 'BarChart3', nameKey: 'onboarding.module.analytics.name', descKey: 'onboarding.module.analytics.desc', benefitKey: 'onboarding.module.analytics.benefit' },
  ...
  { id: 'employees', iconName: 'UserCog', nameKey: 'onboarding.module.employees.name', descKey: 'onboarding.module.employees.desc', benefitKey: 'onboarding.module.employees.benefit' },
  { id: 'shipments', iconName: 'Truck', nameKey: 'onboarding.module.shipments.name', descKey: 'onboarding.module.shipments.desc', benefitKey: 'onboarding.module.shipments.benefit' },
  { id: 'suppliers', iconName: 'Building2', nameKey: 'onboarding.module.suppliers.name', descKey: 'onboarding.module.suppliers.desc', benefitKey: 'onboarding.module.suppliers.benefit' },
