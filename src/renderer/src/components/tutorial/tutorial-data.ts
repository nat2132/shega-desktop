  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        placeholderText: 'e.g. Search by product name...',
      ...
      },
      {
        id: 'inv-add-dialog',
        title: 'Add Item Form',
        description: 'The Add Item form captures all product details including name, brand, quality, category, pricing, supplier, and expiry information.',
      ...
      },
      {
        ...
        instruction: 'Type a descriptive name (e.g. "Premium Widget"). Be specific so you can find it easily later.',
        placeholderText: 'e.g. Premium Widget',
        exampleValue: 'Premium Widget',
      ...
      },
      {
        ...
        instruction: 'Type the brand name (e.g. "Acme Corp") or leave blank if unbranded. This field is optional.',
      ...
      },
      {
        ...
        instruction: 'Enter a grade (e.g. "Grade A"). This is optional but useful for inventory analysis.',
        placeholderText: 'e.g. Grade A',
        exampleValue: 'Grade A',
      ...
      },
      {
        ...
        instruction: 'Fill in Pack Cost (e.g. 1500 ETB), Base Cost (per piece), Pack Price (selling price per box), and Base Price (selling price per piece).',
      ...
      },
      {
        ...
        instruction: 'Select a supplier from the dropdown. Set the expiry date (e.g. 2026-07-15) if the item is perishable. Enable "Credit Purchase" if buying on credit terms.',
      ...
      },
      {
        ...
        placeholderText: 'e.g. Search products...',
        targetSelector: 'input[data-slot="input"]',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        placeholderText: 'e.g. Search items...',
        targetSelector: 'input[data-slot="input"]',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
      ...
      },
      {
        ...
        placeholderText: 'e.g. Abebe Kebede',
    ...
    steps: [
      {
        ...
        instruction: 'This is where you track all business expenses. From here you can view expense history, add new expenses, set budgets, and monitor spending patterns. Take a moment to explore the layout before we begin.',
        tooltipPosition: 'center',
      },
      // ── Add Expense Form ──
      {
      ...
      },
      {
        ...
        placeholderText: 'e.g. Office Rent — July',
        exampleValue: 'Office Rent — July',
        targetSelector: 'input[data-slot="input"]',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        placeholderText: 'e.g. +251 911 234 567',
        exampleValue: '+251 911 234 567',
        targetSelector: 'input[data-slot="input"]',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
      ...
      },
      {
        ...
        placeholderText: 'e.g. Bole Road, Addis Ababa',
        exampleValue: 'Bole Road, Addis Ababa',
        targetSelector: 'input[data-slot="input"]',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        placeholderText: 'e.g. Main Warehouse — Bole',
        exampleValue: 'Main Warehouse — Bole',
        targetSelector: 'input[data-slot="input"]',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        placeholderText: 'e.g. 5 cartons damaged during transport',
        exampleValue: '5 cartons damaged during transport',
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        placeholderText: 'e.g. Receipt #12345',
        exampleValue: 'Receipt #12345',
        targetSelector: 'input[data-slot="input"]',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        placeholderText: 'e.g. Deliver after 5 PM',
        exampleValue: 'Deliver after 5 PM',
        targetSelector: 'textarea',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
      {
        ...
        placeholderText: 'e.g. Search for products...',
        targetSelector: 'input[data-slot="input"]',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        placeholderText: 'e.g. Biruk Alemu',
        exampleValue: 'Biruk Alemu',
        targetSelector: 'input[data-slot="input"]',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        placeholderText: 'e.g. Search by name or phone...',
        targetSelector: 'input[data-slot="input"]',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
      ...
      },
      {
        ...
        placeholderText: 'e.g. Prefers delivery on Tuesdays',
        exampleValue: 'Prefers delivery on Tuesdays',
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        placeholderText: 'e.g. Electricity Bill Due',
        exampleValue: 'Electricity Bill Due',
      ...
      },
      {
        ...
        placeholderText: 'e.g. Pay 5000 ETB for electricity bill',
        exampleValue: 'Pay 5000 ETB for electricity bill',
        targetSelector: 'textarea[data-slot="textarea"]',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        placeholderText: 'e.g. Sara Tadesse',
        exampleValue: 'Sara Tadesse',
        targetSelector: 'input[data-slot="input"]',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
      ...
      },
      {
        ...
        placeholderText: 'e.g. Cashier',
        exampleValue: 'Cashier',
        targetSelector: 'input[data-slot="input"]',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
  ...
  // ═══════════════════════════════════════════════════════════════
  {
    ...
    steps: [
      ...
      },
      {
        ...
        placeholderText: 'e.g. ABC123456',
        exampleValue: 'ABC123456',
        targetSelector: 'input[data-slot="input"]',
        tooltipPosition: 'bottom',
        waitForInteraction: true,
      },
