...
const OnboardingWizard: React.FC<OnboardingWizardProps> = ({ onComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center" style={{ background: '#0B0705' }}>
      ...
      <div className={`w-full max-w-2xl px-10 py-8 relative z-10 transition-all duration-700 ease-out ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
        {/* Progress bar */}
