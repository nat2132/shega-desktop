  ...
  "relative w-full rounded-xl border px-4 py-3 text-sm grid has-[>svg]:grid-cols-[calc(var(--spacing)*4)_1fr] grid-cols-[0_1fr] has-[>svg]:gap-x-3 gap-y-0.5 items-start [&>svg]:size-4 [&>svg]:translate-y-0.5 [&>svg]:text-current",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-amber-500/20 bg-amber-500/5 text-amber-700 dark:text-amber-400 [&>svg]:text-amber-500",
        success:
          "border-emerald-500/20 bg-emerald-500/5 text-emerald-700 dark:text-emerald-400 [&>svg]:text-emerald-500",
      },
    },
    defaultVariants: {
      variant: "default",
