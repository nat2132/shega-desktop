import { c as createLucideIcon, a4 as useParams, d as useNavigate, b as useSettings, g as useAuth, r as reactExports, Q as toast, j as jsxRuntimeExports, e as Button, a5 as ArrowLeft, a6 as Hash, i as Badge, s as Trash2, o as Receipt, a7 as Separator, a1 as User, a8 as CreditCard, S as ShoppingBag, V as Dialog, W as DialogContent, Z as DialogHeader, _ as DialogTitle, $ as DialogDescription, J as Input, a0 as DialogFooter, Y as DialogClose, M as Modal } from "./index-C0Jx5v6F.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent, d as CardDescription } from "./card-CjgAuJMU.js";
import { L as Label } from "./label-PBX5Yn39.js";
import { A as AlertDialog, h as AlertDialogTrigger, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel, g as AlertDialogAction } from "./alert-dialog-BqNqq2Wo.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-Dx0ONkN1.js";
import { V as VOID_REASONS, R as RETURN_REASONS } from "./catalog--2K5SCqJ.js";
import { P as Printer } from "./printer-D1ChGh7J.js";
import { S as SquarePen } from "./square-pen-kVZjEIov.js";
import { U as Undo2 } from "./undo-2-DQdpYxer.js";
...
const SaleDetail = () => {
  ...
  const [voidCustomReason, setVoidCustomReason] = reactExports.useState("");
  ...
  const handleVoidSale = async () => {
    if (!sale) return;
    const reason = voidReason === "other" && voidCustomReason.trim() ? voidCustomReason.trim() : voidReason;
    if (!reason) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6 py-4 md:py-6 fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 lg:px-6 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: isDebt ? "destructive" : "default", className: "uppercase text-xs font-bold tracking-widest", children: isDebt ? t("sales.debt") : t("sales.paid") })
          ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: handlePrint, className: "h-9 text-xs font-black uppercase tracking-widest rounded-xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Printer, { className: "h-3.5 w-3.5 mr-1.5" }),
          " ",
          t("common.print")
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => setShowEditDialog(true), className: "h-9 text-xs font-black uppercase tracking-widest rounded-xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SquarePen, { className: "h-3.5 w-3.5 mr-1.5" }),
          " ",
          t("common.edit")
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: openReturn, className: "h-9 text-xs font-black uppercase tracking-widest rounded-xl text-amber-500 border-amber-500/30 hover:bg-amber-500/10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Undo2, { className: "h-3.5 w-3.5 mr-1.5" }),
          " ",
          t("common.return")
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => setShowDeleteDialog(true), className: "h-9 text-xs font-black uppercase tracking-widest rounded-xl text-destructive border-destructive/30 hover:bg-destructive/10", children: [
        ...
        hasPermission("sales.void") && sale && sale.status !== "Voided" && /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "destructive", size: "sm", className: "h-8 text-xs font-black uppercase tracking-widest", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground mb-2 block", children: t("sale_detail.void_reason_label") }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: voidReason, onValueChange: (v) => {
                setVoidReason(v);
                if (v !== "other") setVoidCustomReason("");
              }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-full rounded-xl bg-muted/20 border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: t("sale_detail.void_reason_placeholder", "Select a reason…") }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: VOID_REASONS.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: r.value, children: r.label }, r.value)) })
              ] }),
              voidReason === "other" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "textarea",
                {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 lg:px-6 grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "rounded-[32px] border-border/60 shadow-sm", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "border-b border-border/40 pb-5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-xs font-black uppercase tracking-[0.3em] text-primary flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5 space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("reports.date") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("sales.customer") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("sales.payment_method") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("sales.payment_status") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: isDebt ? "destructive" : "default", className: "uppercase text-xs font-bold tracking-widest", children: isDebt ? t("sales.debt") : t("sales.paid") })
            ] })
          ] }),
          isDebt && sale.dueDate && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-9 w-9 rounded-xl bg-muted flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "h-4 w-4 text-muted-foreground" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("sales.due_date") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "rounded-[32px] border-border/60 shadow-sm lg:col-span-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-border/50 bg-muted/10 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/30 text-xs font-black uppercase tracking-widest", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "pt-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 rounded-2xl bg-muted/20 border border-border/40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground mb-1", children: t("sales.subtotal") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 rounded-2xl bg-muted/20 border border-border/40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground mb-1", children: t("sales.discount") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 rounded-2xl bg-muted/20 border border-border/40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground mb-1", children: t("sales.vat") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 rounded-2xl bg-primary/10 border border-primary/30", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-primary mb-1", children: t("sales.total_price") }),
          ...
          isDebt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 rounded-2xl bg-destructive/10 border border-destructive/30", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-destructive mb-1", children: t("sales.due_amount") }),
          ...
          !isDebt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 rounded-2xl bg-green-500/10 border border-green-500/30", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-green-500 mb-1", children: t("sales.paid_amount") }),
    ...
    isDebt && paymentHistory.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 lg:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "rounded-[32px] border-border/60 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "border-b border-border/40 pb-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-xs font-black uppercase tracking-[0.3em] text-primary flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(History, { className: "h-3.5 w-3.5" }),
          " ",
          t("sales.payment_history")
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardDescription, { className: "text-xs font-bold text-muted-foreground uppercase tracking-widest", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showEditDialog, onOpenChange: setShowEditDialog, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "bg-background rounded-[32px] border-border shadow-2xl sm:max-w-xl p-0 gap-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { className: "p-6 border-b border-border/50", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogDescription, { className: "text-xs font-bold text-muted-foreground uppercase tracking-widest", children: [
          t("inventory.product"),
          ": ",
          sale.itemName
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("sales.customer_name") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("sales.phone_number") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("inventory.quantity") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                type: "number",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { className: "p-6 border-t border-border/50 flex gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DialogClose, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", className: "rounded-xl h-11 text-xs font-black uppercase tracking-widest flex-1", children: t("common.cancel") }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleEdit, disabled: saving || editForm.quantity < 1, className: "rounded-xl h-11 text-xs font-black uppercase tracking-widest flex-1 shadow-lg", children: saving ? t("common.saving") : t("common.confirm") })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showReturnModal, onClose: () => setShowReturnModal(false), title: t("common.return"), size: "sm", children: sale && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleReturn, className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: t("sales.refund_hint") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: returnReason, onValueChange: (v) => {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-10 w-full rounded-xl bg-muted/20 border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: t("sales.return_reason_placeholder", "Select a reason…") }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "outline", className: "flex-1 rounded-xl h-11 text-xs font-black uppercase tracking-widest", onClick: () => setShowReturnModal(false), children: t("common.cancel") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            type: "submit",
            className: "flex-1 rounded-xl h-11 text-xs font-black uppercase tracking-widest shadow-lg",
            disabled: !returnQty || parseFloat(returnQty) < 1 || !returnReason || returnReason === "other" && !returnCustomReason.trim(),
            children: t("common.process")
          }
        )
      ] })
    ] }) }),
