import { c as createLucideIcon, b as useSettings, r as reactExports, as as Users, a5 as History, j as jsxRuntimeExports, e as Button, a1 as Search, K as Input, R as RefreshCw, g as Badge, h as Trash2, M as Modal, t as toast } from "./index-ym3eqgeD.js";
import { D as DatePicker } from "./DatePicker-D2bBCjpA.js";
import { S as ShieldCheck } from "./shield-check-o5OsJBYN.js";
import { U as UserPlus } from "./user-plus-FWZFftE_.js";
import { P as Pen } from "./pen-T_aCO6gz.js";
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border bg-card/40 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
            accounts.map((acct) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/20 hover:bg-muted/20 transition-colors", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-[10px] font-semibold", children: acct.lastLogin ? new Date(acct.lastLogin).toLocaleString() : "-" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border bg-card/40 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
            logs.map((log) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/20 hover:bg-muted/20 transition-colors", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-[10px] font-semibold", children: new Date(log.createdAt).toLocaleString() }),
