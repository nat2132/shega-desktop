import { c as createLucideIcon, b as useSettings, r as reactExports, j as jsxRuntimeExports, g as Badge, e as Button, z as Sheet, D as SheetTrigger, F as Filter, G as SheetContent, H as SheetHeader, J as SheetTitle, K as SheetDescription, N as SheetFooter, O as SheetClose, M as Modal, ad as CreditCard, V as Input, n as Trash2, t as toast } from "./index-DQvMvM6p.js";
import { E, b as addPdfHeader, c as autoTable } from "./export-utils-CXBpemmh.js";
import { S as SectionCards } from "./section-cards-C9-heLdM.js";
import { D as DataTable } from "./data-table-L05MP4IV.js";
import { T as Textarea } from "./textarea-BeMU5apB.js";
import { L as Label } from "./label-CRpD9KNw.js";
...
import { P as Pencil } from "./pencil-DABKP5V6.js";
import { P as Printer } from "./printer-3hdxa829.js";
import { P as Phone } from "./phone-mAlUW2fK.js";
import { M as Mail } from "./mail-B0NF3zZS.js";
import { M as MapPin } from "./map-pin-YmErlmaZ.js";
import { S as Save } from "./save-C7Qe32xI.js";
import { H as History } from "./history-JOpG8F0b.js";
import "./card-MD6aRxed.js";
      ...
      cell: ({ row }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            row.original.groupName !== "general" && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-[9px] h-4 px-1", children: translateGroupName(row.original.groupName) })
          ] })
        ] })
      ] })
    },
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open: isFilterOpen, onOpenChange: setIsFilterOpen, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: `h-8 px-3 transition-all ${filterGroup !== "All" || filterCity !== "All" || filterStatus !== "All" ? "border-primary text-primary bg-primary/5 shadow-sm" : "border-border/60 hover:bg-muted/50"}`, children: [
            ...
            " ",
            (filterGroup !== "All" || filterCity !== "All" || filterStatus !== "All") && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "ml-1.5 h-4 px-1 text-[9px] rounded-full", children: t("common.active", "Active") })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "right", className: "w-[400px] sm:w-[540px] border-l-border/40 p-0 flex flex-col", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetHeader, { className: "border-b border-border/50 p-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SheetDescription, { className: "text-[10px] font-bold text-muted-foreground uppercase tracking-widest", children: t("customers.filters_desc", "Refine your customer view") })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 p-6 flex-1 overflow-y-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-primary", children: t("customers.group", "Group") }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-primary", children: t("customers.city", "City") }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-primary", children: t("common.status", "Status") }),
        ...
        children: selectedCustomer && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs bg-muted/20 p-2 rounded-lg", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[9px] h-4 px-1", children: translateGroupName(selectedCustomer.groupName) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs bg-muted/20 p-2 rounded-lg", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 max-h-32 overflow-y-auto my-2", children: [
              customerNotes.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground italic", children: t("customers.no_notes", "No notes recorded") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border rounded-lg overflow-hidden mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { className: "text-xs", children: [
                ...
                customerSales.filter((s) => s.paymentStatus === "Debt").length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 5, className: "px-3 py-4 text-center text-muted-foreground text-[10px]", children: t("customers.no_outstanding_debts", "No outstanding debts") }) })
              ] })
            ] }) })
          ] })
        ] })
      ...
      Modal,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSaveCustomer, className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("customers.group", "Group") }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("common.phone", "Phone") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("customers.secondary_phone", "Secondary Phone") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("common.email", "Email") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  type: "email",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("customers.company", "Company") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("customers.tax_number", "Tax Number") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("customers.city", "City") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("customers.address", "Address") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("customers.notes", "Notes") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 ml-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "outline", onClick: () => setShowFormModal(false), className: "h-8 text-[10px] font-bold uppercase tracking-widest px-3", children: t("common.cancel", "Cancel") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", className: "h-8 text-[10px] font-bold uppercase tracking-widest px-3", children: isEditing ? t("customers.update_customer", "Update Customer") : t("customers.create_customer", "Create Customer") })
            ] })
          ] })
        ] })
      }
