import { b as useSettings, r as reactExports, j as jsxRuntimeExports, e as Button, aT as BellOff, B as Bell, g as Badge, p as Clock, h as Trash2, M as Modal, K as Input, t as toast } from "./index-BzfzhNvZ.js";
...
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-D9rQjtzn.js";
...
const ReminderHistory = () => {
  ...
  const getStatusBadge = (status) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: c.variant, className: "uppercase text-[9px] font-bold", children: c.label });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 py-4 md:gap-6 md:py-6 fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 lg:px-6 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground font-black uppercase tracking-widest mt-1", children: t("reminders.subtitle") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: openCreate, className: "h-11 px-5 text-[10px] font-black uppercase tracking-widest rounded-xl shadow-lg", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 lg:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: activeTab, className: "space-y-3 mt-0", children: filteredReminders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-20 text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground font-bold mt-1", children: t("reminders.create_first") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { onClick: openCreate, variant: "outline", size: "sm", className: "mt-4 h-9 text-[9px] font-black uppercase tracking-widest rounded-lg", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2 mt-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "uppercase text-[9px] font-bold", children: getTypeLabel(reminder.type) }),
              getStatusBadge(reminder.status)
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-4 mt-3 text-[10px] text-muted-foreground font-bold uppercase tracking-wider", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 shrink-0", children: [
            reminder.status === "active" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative group/snooze", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute right-0 top-full mt-1 hidden group-hover/snooze:flex flex-col bg-popover border rounded-xl shadow-xl p-1 z-10 min-w-[100px]", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", className: "h-7 justify-start text-[9px] font-black uppercase tracking-widest rounded-lg", onClick: () => handleSnooze(reminder.id, 1), children: t("reminders.snooze_1h") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", className: "h-7 justify-start text-[9px] font-black uppercase tracking-widest rounded-lg", onClick: () => handleSnooze(reminder.id, 24), children: t("reminders.snooze_1d") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", className: "h-7 justify-start text-[9px] font-black uppercase tracking-widest rounded-lg", onClick: () => handleSnooze(reminder.id, 168), children: t("reminders.snooze_1w") })
              ] })
            ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showModal, onClose: () => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground border-b border-border/50 pb-2", children: t("reminders.reminder_title") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("reminders.reminder_title") }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("reminders.reminder_type") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("reminders.reminder_message") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground border-b border-border/50 pb-2", children: t("reminders.trigger_at") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("reminders.trigger_at") }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: !!deleteId, onOpenChange: () => setDeleteId(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { className: "rounded-[32px] bg-background border-border shadow-2xl", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { className: "gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogAction, { onClick: () => deleteId && handleDelete(deleteId), className: "rounded-xl bg-destructive text-destructive-foreground hover:bg-destructive/90 h-11 text-[10px] font-black uppercase tracking-widest", children: t("reminders.delete_reminder") })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] font-black uppercase tracking-tighter", children: t("reminders.new_reminder") })
        ]
      }
    )
  ] });
