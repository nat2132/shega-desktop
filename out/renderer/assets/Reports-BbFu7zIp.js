import { b as useSettings, r as reactExports, j as jsxRuntimeExports, i as Truck, w as Receipt, m as Package, e as Button, L as LoaderCircle, k as ChartColumn, f as CircleAlert, R as RefreshCw, ac as Separator, T as TriangleAlert, g as Badge, V as Input, n as Trash2, Q as FileText, ad as CreditCard, P as PiggyBank, Z as Download, t as toast } from "./index-DQvMvM6p.js";
import { E, b as addPdfHeader, c as autoTable, e as exportCSV, a as exportPDF } from "./export-utils-CXBpemmh.js";
...
import { T as Tabs, a as TabsList, b as TabsTrigger } from "./tabs-DSqMyoyu.js";
import { T as Table, a as TableHeader, b as TableRow, c as TableHead, d as TableBody, e as TableCell } from "./table-C9uWuD7Q.js";
...
import { B as Boxes } from "./boxes-DXnCrcaM.js";
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-4 @xl/main:grid-cols-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-3xl border-border bg-gradient-to-t from-primary/5 to-card shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start mb-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[9px] font-black uppercase tracking-widest", children: t("reports.outstanding_badge") })
            ] }),
      ...
      case "inventory_by_supplier":
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-4 @xl/main:grid-cols-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-3xl border-border bg-gradient-to-t from-primary/5 to-card shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-[9px] font-black uppercase tracking-widest mb-1", children: t("reports.total_stock_badge") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-3xl border-border bg-gradient-to-t from-primary/5 to-card shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-start mb-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 bg-muted rounded-xl text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { size: 20 }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[9px] font-black uppercase tracking-widest", children: t("reports.value_badge") })
            ] }),
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "rounded-3xl border-border", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-[10px] font-black uppercase tracking-widest text-right", children: t("reports.id_header") }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: reversalData.map((row, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: row.action === "reverse_payment" ? "default" : "secondary", className: "text-[8px] font-black uppercase", children: row.action === "reverse_payment" ? t("reports.badge_payment") : t("reports.badge_adjustment") }) }),
