import { c as createLucideIcon, b as useSettings, ad as useIsMobile, r as reactExports, p as toEthiopianDate, q as getEthiopianMonthName, j as jsxRuntimeExports, g as Badge, e as Button, n as Trash2, ae as ChartPie, l as TrendingDown, O as FileText, M as Modal, Q as Input, t as toast } from "./index-BQyt5yx7.js";
...
import { C as Card, a as CardHeader, b as CardTitle, d as CardDescription, e as CardAction, c as CardContent } from "./card-BckdbOp1.js";
import { T as ToggleGroup, b as ToggleGroupItem, C as ChartContainer, c as ChartTooltip, a as ChartTooltipContent } from "./toggle-group-C_Cm8IEY.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-DvFPMP5U.js";
import { A as AreaChart, a as Area, B as Briefcase } from "./AreaChart-DUisj8_u.js";
import { ag as CartesianGrid, ah as XAxis } from "./CartesianChart-CtFYKNPV.js";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-4 py-4 md:gap-6 md:py-6 fade-in", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, className: "w-full", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8 rounded-[32px] border border-border/50 bg-card shadow-xl flex items-center justify-between relative overflow-hidden group", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right pr-12 hidden md:block", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-2xl font-black text-green-600", children: [
                t("expense.projected_savings_value") || "-12%",
                " ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "budget", className: "mt-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 lg:px-6 space-y-6", children: [
          ...
          (() => {
            ...
            return totalBudget > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 rounded-3xl border border-border/50 bg-card shadow-xl flex items-center gap-8", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground", children: isOver ? t("expense.budget_over") : t("expense.budget_health") }),
          ...
          budgets.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-12 rounded-3xl border border-border/50 bg-card flex flex-col items-center justify-center text-center space-y-3", children: [
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 rounded-3xl border border-border/50 bg-card shadow-xl space-y-4 relative overflow-hidden group", children: [
              isOver && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-0 right-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", className: "rounded-bl-2xl rounded-tr-3xl text-[9px] font-black uppercase px-3 py-1.5", children: t("expense.budget_over") }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground uppercase font-bold tracking-widest", children: t("expense.budget_period", { period: budget.period }) })
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { className: "rounded-[32px] bg-background border-border shadow-2xl", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogFooter, { className: "gap-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogCancel, { className: "rounded-xl border-border h-11 text-[10px] font-black uppercase tracking-widest", children: t("common.cancel") }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        AlertDialogAction,
                        {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("budgets.budget") }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("budgets.spent") }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("budgets.remaining") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: budgetModal, onClose: () => setBudgetModal(false), title: t("budgets.set_budget"), size: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSetBudget, className: "space-y-8 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground border-b border-border/50 pb-2", children: t("expense.budget_details") }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("budgets.category") }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("budgets.period") }),
