import { c as createLucideIcon, b as useSettings, r as reactExports, _ as toast, j as jsxRuntimeExports, U as Users, e as Button, a9 as Search, V as Input, R as RefreshCw, a7 as User, y as Trash2, ay as Copy, a0 as Dialog, a1 as DialogContent, a3 as DialogHeader, a4 as DialogTitle, az as Building2, g as Badge } from "./index-fMHJoXSU.js";
import { C as Card, c as CardContent } from "./card-MDpMDtbv.js";
...
const Contacts = () => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      toast.error(e2.message || t("contacts.save_error"));
    }
  };
  ...
  const categoryBadge = (cat) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: variantMap[cat] || "outline", className: "text-xs gap-1", children: [
      CATEGORY_ICONS[cat],
      labelMap[cat] || cat
    ] });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 py-4 md:gap-6 md:py-6 fade-in px-4 lg:px-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 flex-wrap", children: ["all", ...CATEGORIES].map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        ...
        children: cat === "all" ? t("common.all") : CATEGORY_ICONS[cat] ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
          CATEGORY_ICONS[cat],
          t(`contacts.${cat}`)
        ] }) : t(`contacts.${cat}`)
      },
    ...
    loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "h-8 w-8 animate-spin text-muted-foreground" }) }) : filtered.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-16 text-muted-foreground", children: [
      ...
      contact.subCategory && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-muted-foreground mb-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs font-black uppercase tracking-widest", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: showForm, onOpenChange: setShowForm, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-md", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSave, className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Select,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: t("contacts.select_category") }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("contacts.sub_category") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("contacts.notes") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
              value: form.notes,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-2 pt-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", children: editingId ? t("contacts.edit_contact") : t("common.save") })
        ] })
      ] })
    ] }) }),
