import { c as createLucideIcon, b as useSettings, m as useAuth, r as reactExports, j as jsxRuntimeExports, q as Truck, e as Button, B as Bell, as as Users, a1 as Search, K as Input, R as RefreshCw, g as Badge, w as Eye, aL as Archive, h as Trash2, aI as ChevronRight, a4 as CreditCard, an as Building2, p as Clock, M as Modal } from "./index-1f1mrYRP.js";
import { E, b as addPdfHeader, c as autoTable } from "./export-utils-DJTtd_HY.js";
import { A as AlertDialog, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel, g as AlertDialogAction } from "./alert-dialog-BfirtEch.js";
import { C as Card, c as CardContent, a as CardHeader, b as CardTitle, L as Label } from "./label-CasNofhH.js";
...
import { D as DollarSign } from "./dollar-sign-BpuCGjL4.js";
import { T as TrendingUp } from "./trending-up-cp0G4rrN.js";
import { S as SquarePen } from "./square-pen-FQXOOXtq.js";
...
import { B as Ban } from "./ban-D0Zv7QOu.js";
...
const Suppliers = () => {
  ...
  const [showTestMenu, setShowTestMenu] = reactExports.useState(false);
  ...
  const handleSave = async () => {
    if (!form.supplierName.trim()) {
      showToast(t("suppliers.field_name") + " is required", "error");
      return;
    }
    try {
      if (editingId) {
  ...
  const exportPDF = () => {
    ...
    doc.text("Suppliers Report", 14, y);
    y += 8;
    doc.setFontSize(9);
    doc.setFont("helvetica", "normal");
    doc.text(`Generated: ${formatDate(/* @__PURE__ */ new Date())}`, 14, y);
    ...
    toast2.success("Report exported successfully");
  };
  const exportCSV = () => {
  ...
  if (view === "list") {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 p-2 fade-in", children: [
      toast2 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `fixed bottom-4 right-4 z-50 px-4 py-2 rounded shadow ${toast2.type === "success" ? "bg-green-600" : "bg-red-600"} text-white text-sm`, children: toast2.message }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "h-8 w-8 animate-spin text-muted-foreground" }) }) : suppliers.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-16 text-muted-foreground", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: paged.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: `border-t hover:bg-muted/20 ${selectedIds.includes(s.id) ? "bg-muted/30" : ""}`, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: s.isActive ? "default" : "secondary", className: "text-[10px]", children: s.isActive ? t("suppliers.status_active") : t("suppliers.status_inactive") }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: form.phone, onChange: (e) => setForm({ ...form, phone: e.target.value }), placeholder: "+251..." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 p-2 fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: selected.isActive ? "default" : "secondary", children: selected.status || (selected.isActive ? "Active" : "Inactive") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: selectedSupplierPurchases.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground p-4 text-center", children: t("suppliers.empty_purchases") }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: selectedSupplierPurchases.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t hover:bg-muted/20", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: p.status === "received" ? "default" : "secondary", className: "text-[10px]", children: p.status }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: selectedSupplierPayments.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground p-4 text-center", children: t("suppliers.empty_payments") }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: selectedSupplierPayments.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t hover:bg-muted/20", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[10px]", children: p.paymentMethod }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-0", children: selectedProducts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground p-4 text-center", children: t("suppliers.empty_products") }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/30", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left p-2", children: "SKU" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: priceChecks.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-muted-foreground py-4 text-center", children: "No price check reminders scheduled" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-3", children: priceChecks.map((pc) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-3xl border border-border bg-card p-4 space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-semibold text-sm", children: pc.itemName || "All Items" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 text-xs", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground uppercase tracking-widest", children: "Last" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: pc.lastCheckedDate ? formatDate(pc.lastCheckedDate) : "Never" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground uppercase tracking-widest", children: "Next" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: pc.nextCheckDate ? formatDate(pc.nextCheckDate) : "N/A" })
            ] })
          ] }),
      ...
      supplierActivity.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: supplierActivity.map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 text-sm", children: [
      ...
      showPriceCheckModal && /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showPriceCheckModal, title: "Schedule Price Check", onClose: () => setShowPriceCheckModal(false), children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 min-w-[420px]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium uppercase tracking-widest text-muted-foreground", children: "Supplier" }),
          selected ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border rounded px-3 py-2 bg-background text-sm mt-1", children: selected.supplierName }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: 0, children: "Select supplier" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium uppercase tracking-widest text-muted-foreground", children: "Item (optional)" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              className: "w-full border rounded px-2 py-1.5 bg-background text-sm mt-1",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium uppercase tracking-widest text-muted-foreground", children: "Frequency" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
              className: "w-full border rounded px-2 py-1.5 bg-background text-sm mt-1",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium uppercase tracking-widest text-muted-foreground", children: "Notes" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "textarea",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "pc-active", className: "text-sm", children: "Active" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 justify-end", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: () => setShowPriceCheckModal(false), children: "Cancel" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleSavePriceCheck, children: "Save" })
        ] })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: reversePaymentTarget !== null, onOpenChange: (open) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Reverse Payment" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium", children: "Reason for reversal *" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
              required: true,
