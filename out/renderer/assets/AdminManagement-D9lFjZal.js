import { c as createLucideIcon, n as useAuth, b as useSettings, r as reactExports, j as jsxRuntimeExports, ap as cn, a_ as Crown, g as Badge, e as Button, y as Trash2, M as Modal, V as Input, a$ as EyeOff, x as Eye } from "./index-D0em7kRt.js";
...
import { S as SectionCards } from "./section-cards-ZImu4He1.js";
import { D as DataTable } from "./data-table-DUTJ12F4.js";
import { P as Pencil } from "./pencil-sk8jZ-fH.js";
import { P as Plus } from "./plus-C617I_e3.js";
import "./card-BfGvUZ57.js";
import "./trending-up-C2WkiYxx.js";
import "./label-BY5hKnMF.js";
import "./select-D9ZBWN4s.js";
import "./table-B-Nddpo3.js";
import "./tabs-BPeeFIqV.js";
/**
...
const AdminManagement = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: ({ row }) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1 max-w-[200px]", children: row.original.role === "super_admin" ? /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs font-bold bg-primary/5 border-primary/20 text-primary", children: t("admin.full_access") }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        row.original.permissions.slice(0, 3).map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs font-bold", children: p }, p)),
        row.original.permissions.length > 3 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "text-xs font-bold", children: [
          "+",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 py-4 md:gap-6 md:py-6 fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showModal, onClose: () => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-black uppercase tracking-[0.3em] text-muted-foreground border-b border-border/50 pb-2", children: t("admin.identity") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground", children: t("admin.display_name") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  required: true,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground", children: t("admin.username") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  required: true,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-black uppercase tracking-[0.3em] text-muted-foreground border-b border-border/50 pb-2", children: editingAdmin ? t("admin.pin_reset") : t("admin.security_pin") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground", children: t("admin.pin_code") }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground", children: t("admin.confirm_pin") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  type: showPin ? "text" : "password",
        ...
        (!editingAdmin || editingAdmin.role !== "super_admin") && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border/50 pb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-black uppercase tracking-[0.3em] text-muted-foreground", children: t("admin.access_permissions") }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: selectAllPermissions, className: "text-xs font-black uppercase tracking-widest text-primary hover:underline", children: t("common.max") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground/30", children: "|" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", onClick: clearAllPermissions, className: "text-xs font-black uppercase tracking-widest text-muted-foreground hover:underline", children: t("common.abort") })
            ] })
          ] }),
        ...
        editingAdmin?.role === "super_admin" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 rounded-2xl border bg-primary/5 border-primary/20 flex items-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest", children: t("admin.super_admins") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-bold", children: t("admin.super_admin_desc") })
          ] })
        ] }),
        error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 rounded-xl bg-destructive/10 border border-destructive/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-destructive text-xs font-black uppercase tracking-widest", children: error }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-black uppercase tracking-tighter", children: t("common.operator") })
        ]
      }
    )
  ] });
