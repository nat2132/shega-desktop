import { r as reactExports, j as jsxRuntimeExports, N as cn, g as useSettings, m as Badge, ai as Search, i as Button, X, am as Receipt, x as Plus, ao as CreditCard } from "./index-wvHtiMql.js";
import { P as PackageSearch } from "./package-search-Byov47O9.js";
import { M as Minus } from "./minus-BMLR_Lj1.js";
...
function Register() {
  ...
  const [categories, setCategories] = reactExports.useState([{ id: 0, name: "All" }]);
    ...
    try {
      ...
      try {
        ...
        if (Array.isArray(cats) && cats.length > 0) {
          setCategories([{ id: 0, name: "All" }, ...cats.map((c) => ({ id: c.id, name: c.name || "" }))]);
        }
      } catch (_) {
      }
    } catch (e) {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto p-4", children: filteredItems.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full text-muted-foreground", children: [
          ...
          "button",
          {
            ...
            className: `relative p-3 rounded-xl border-2 transition-all text-left group ${item.totalBaseQuantity <= 0 ? "bg-muted/50 border-muted text-muted-foreground opacity-50 cursor-not-allowed" : "bg-card border-border hover:border-primary/50 hover:shadow-lg hover:-translate-y-1 active:scale-[0.98]"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative mb-2 aspect-square w-full overflow-hidden rounded-lg bg-muted", children: item.image ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: item.image,
                  alt: item.name,
              ...
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full w-full items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PackageSearch, { className: "h-8 w-8 text-muted-foreground/30" }) }) }),
