import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, m as Badge, C as CircleCheck, ae as ShieldAlert, a_ as ShieldX, i as Button, n as RefreshCw, g as useSettings, O as useAuth, p as Truck, x as Plus, U as Users, ai as Search, G as Input, a0 as Eye, F as Archive, a1 as RotateCcw, y as Trash2, aD as ChevronLeft, aE as ChevronRight, ao as CreditCard, v as Building2, o as Clock, M as Modal } from "./index-wvHtiMql.js";
...
function isVerificationFresh(v, now = Date.now()) {
  if (!v.cacheUntil) return v.status !== "unavailable" && v.status !== "failed";
  return now < new Date(v.cacheUntil).getTime();
}
function verificationAgeLabel(cachedAt, now = Date.now()) {
  if (!cachedAt) return "";
...
function MorStatusBadge({ verification }) {
  ...
  if (!verification) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "gap-1 bg-muted/50 text-muted-foreground", children: [
  ...
  if (isMorVerified(verification)) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: `gap-1 ${stale ? "bg-amber-500/15 text-amber-600" : "bg-green-500/15 text-green-600"}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-3.5 w-3.5" }),
      stale ? "Verified · refresh recommended" : "Verified by Ministry of Revenues",
      isVerificationFresh(verification, now) && verification.cachedAt ? ` · ${verificationAgeLabel(verification.cachedAt, now)}` : ""
    ] });
  }
  if (verification.status === "unavailable") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "gap-1 bg-amber-500/10 text-amber-600", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldAlert, { className: "h-3.5 w-3.5" }),
      " Verification unavailable"
    ] });
  }
  if (verification.status === "failed") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "gap-1 bg-red-500/10 text-red-600", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldX, { className: "h-3.5 w-3.5" }),
      " Verification failed"
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "gap-1 bg-muted/50 text-muted-foreground", children: [
...
function MorVerifyAction({
  ...
  const lookupCached = reactExports.useCallback(async () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
    verification && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(MorStatusBadge, { verification }),
      verification.taxpayerName && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-muted-foreground", children: verification.taxpayerName })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          ...
          className,
          children: [
            busy ? /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { className: "mr-1.5 h-3.5 w-3.5 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldQuestion, { className: "mr-1.5 h-3.5 w-3.5" }),
            verification ? "Refresh from MoR" : label
          ]
        }
      ),
      verification && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: verification.status === "unavailable" || verification.status === "failed" ? reasonText[verification.reason || ""] || verification.reason : isVerificationFresh(verification) ? `Cached ${verificationAgeLabel(verification.cachedAt)} from MoR` : "Cached answer is stale — refresh from MoR to confirm" })
    ] }),
...
const Suppliers = () => {
  ...
  const [supplierVerification, setSupplierVerification] = reactExports.useState(null);
  reactExports.useEffect(() => {
  ...
  if (view === "list") {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 p-2 fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between flex-wrap gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", onClick: () => openForm(), children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4 space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-sm space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [
              ...
              " ",
              selected.taxNumber || "-",
              selected.taxNumber && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MorStatusBadge, { verification: supplierVerification }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  MorVerifyAction,
                  {
