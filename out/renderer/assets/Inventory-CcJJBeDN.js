import { c as createLucideIcon, b as useSettings, r as reactExports, j as jsxRuntimeExports, P as Package, e as Button, w as Eye, h as Trash2, S as Sheet, x as SheetTrigger, F as Filter, g as Badge, y as SheetContent, z as SheetHeader, A as SheetTitle, D as SheetDescription, G as SheetFooter, H as SheetClose, J as FileText, M as Modal, K as Input, X, N as ShoppingCart, t as toast, O as playSound } from "./index-1f1mrYRP.js";
import { e as exportCSV, a as exportPDF, E, b as addPdfHeader, c as autoTable } from "./export-utils-DJTtd_HY.js";
...
const Inventory = () => {
  ...
  const [purchaseForm, setPurchaseForm] = reactExports.useState({ supplierId: "", purchaseDate: (/* @__PURE__ */ new Date()).toISOString().split("T")[0], notes: "" });
  ...
  const handleSubmit = async (e) => {
    ...
    if (basePrice <= 0 && parseFloat(formData.packSellingPrice) <= 0) {
      toast.error("At least one selling price is required");
      return;
    }
  ...
  const exportInventoryPDF = () => {
    ...
    exportPDF("Inventory Report", h, r, "inventory", void 0, void 0, currentBusiness);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: formData.purchaseUnit, onChange: (e) => setFormData({ ...formData, purchaseUnit: e.target.value }), placeholder: "Box/Crate" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: formData.baseUnit, onChange: (e) => setFormData({ ...formData, baseUnit: e.target.value }), placeholder: "Piece/Kg" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showDetailsModal, onClose: () => setShowDetailsModal(false), title: t("inventory.specifications"), size: "lg", children: viewingItem && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 pb-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3.5 rounded-xl border border-border/40 bg-card/50", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold", children: viewingItem.expiryDate || "N/A" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3.5 rounded-xl border border-border/40 bg-card/50", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold", children: viewingItem.supplierName || "N/A" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3.5 rounded-xl border border-border/40 bg-card/50", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold", children: viewingItem.lastPurchaseDate || "N/A" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3.5 rounded-xl border border-border/40 bg-card/50", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showPOModal, onClose: () => setShowPOModal(false), title: t("inventory.po_draft"), size: "xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 pb-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 p-3 rounded-xl border bg-muted/20", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", placeholder: "Qty", value: customItemQty, onChange: (e) => setCustomItemQty(e.target.value), className: "w-20 h-9 text-xs" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "number", placeholder: "Price", value: customItemPrice, onChange: (e) => setCustomItemPrice(e.target.value), className: "w-24 h-9 text-xs" }),
