import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, aP as useComposedRefs, bj as Anchor, ah as Primitive, ai as composeEventHandlers, aT as useLayoutEffect2, bk as Portal, aR as Presence, bl as useId, at as reactDomExports, al as useDirection, ag as useControllableState, bm as Root2, bn as VISUALLY_HIDDEN_STYLES, bo as createPopperScope, bp as createCollection, aS as useCallbackRef, bq as hideOthers, br as useFocusGuards, bs as ReactRemoveScroll, bt as FocusScope, bu as DismissableLayer, an as createContextScope, bv as createSlot, bw as Content, bx as Arrow, ao as cn, aw as Check } from "./index-DQvMvM6p.js";
/**
...
function SelectTrigger({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    SelectTrigger$1,
    {
      ...
      "data-size": size,
      className: cn(
        "flex w-fit items-center justify-between gap-2 rounded-xl border border-border/70 bg-transparent px-3 py-2 text-sm whitespace-nowrap shadow-sm transition-all duration-200 outline-none focus-visible:border-primary focus-visible:ring-[3px] focus-visible:ring-primary/15 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive data-[placeholder]:text-muted-foreground/60 data-[size=default]:h-9 data-[size=sm]:h-8 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center *:data-[slot=select-value]:gap-2 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      ),
      ...props,
      children: [
...
function SelectContent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SelectPortal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    SelectContent$1,
    {
      ...
      className: cn(
        "relative z-50 max-h-(--radix-select-content-available-height) min-w-[8rem] origin-(--radix-select-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-xl border border-border/50 bg-card p-1 shadow-lg backdrop-blur-xl data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:animate-in data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95",
...
function SelectItem({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    SelectItem$1,
    {
      ...
      className: cn(
        "relative flex w-full cursor-default items-center gap-2 rounded-lg py-1.5 pr-8 pl-2 text-sm outline-hidden select-none transition-colors duration-100 focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className
      ),
      ...props,
      children: [
