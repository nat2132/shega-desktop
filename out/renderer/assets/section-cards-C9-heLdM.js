import { j as jsxRuntimeExports, s as motion, g as Badge, l as TrendingDown } from "./index-DQvMvM6p.js";
import { C as Card, a as CardHeader, d as CardDescription, b as CardTitle, e as CardAction, f as CardFooter } from "./card-MD6aRxed.js";
import { T as TrendingUp } from "./trending-up-Cxsw7W9Q.js";
function SectionCards({ cards }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:from-primary/[0.02] *:data-[slot=card]:to-card *:data-[slot=card]:shadow-xs lg:px-6 @xl/main:grid-cols-2 @5xl/main:grid-cols-4", children: cards.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "@container/card relative overflow-hidden", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardAction, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: card.trendType === "up" ? "success" : "warning", className: "gap-1 text-[10px]", children: [
