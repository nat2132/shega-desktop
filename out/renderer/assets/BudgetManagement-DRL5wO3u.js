import { c as createLucideIcon, b as useSettings, r as reactExports, p as toEthiopianDate, q as getEthiopianMonthName, j as jsxRuntimeExports, e as Button, af as ChartPie, k as ChartColumn, Q as FileText, h as Clock, T as TriangleAlert, g as Badge, aW as Copy, n as Trash2, Z as Download, M as Modal, V as Input, t as toast, b5 as fromEthiopianDate } from "./index-DQvMvM6p.js";
import { S as SectionCards } from "./section-cards-C9-heLdM.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-LYbu3WYR.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-DSqMyoyu.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent, d as CardDescription } from "./card-MD6aRxed.js";
import { e as exportCSV, a as exportPDF } from "./export-utils-CXBpemmh.js";
import { W as Wallet } from "./wallet-CbU6vKhN.js";
import { P as Plus } from "./plus-Disu_y1q.js";
import "./trending-up-Cxsw7W9Q.js";
/**
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, children: [
        ...
        alerts.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-yellow-200 bg-yellow-50/50", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-2", children: alerts.slice(0, 5).map((alert) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3 rounded-xl bg-white/60 border border-yellow-200", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: alert.message })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "ghost", className: "h-7 text-[10px] font-bold", onClick: async () => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: `${st.bg} ${st.color} text-[8px] font-black border-0`, children: t(st.labelKey) })
                  ] })
                ] }),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground font-medium", children: t("budgets.percent_used", { percent: cat.usagePercent }) })
              ] }, cat.category);
            }),
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "hover:shadow-md transition-shadow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                budget.isRecurring ? /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[8px] font-black h-4 border-blue-200 text-blue-600 bg-blue-50", children: t("budgets.recurring") }) : null,
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: `${st.bg} ${st.color} text-[8px] font-black border-0`, children: t(st.labelKey) })
              ] }),
              budget.referenceName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground mt-0.5", children: budget.referenceName })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-24", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground font-medium", children: t("budgets.percent_used", { percent: budget.usagePercent }) })
              ] }),
        ...
        report?.categories && report.categories.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-4 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground", children: t("budgets.total_planned") }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground", children: t("budgets.total_spent") }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl font-black mt-1", children: [
                t("common.etb"),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground", children: t("budgets.remaining") }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 text-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground", children: t("budgets.usage") }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xl font-black mt-1", children: [
                report.usagePercent,
                "%"
              ] })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-3 px-2 font-black uppercase tracking-widest text-[9px] text-muted-foreground", children: t("budgets.col_category") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right py-3 px-2 font-black uppercase tracking-widest text-[9px] text-muted-foreground", children: t("budgets.col_planned") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right py-3 px-2 font-black uppercase tracking-widest text-[9px] text-muted-foreground", children: t("budgets.col_actual") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right py-3 px-2 font-black uppercase tracking-widest text-[9px] text-muted-foreground", children: t("budgets.col_remaining") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right py-3 px-2 font-black uppercase tracking-widest text-[9px] text-muted-foreground", children: t("budgets.col_used_percent") }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-right py-3 px-2 font-black uppercase tracking-widest text-[9px] text-muted-foreground", children: t("budgets.col_status") })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: report.categories.map((cat) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/50 hover:bg-muted/20", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-2 text-right", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: `${st.bg} ${st.color} text-[8px] font-black border-0`, children: t(st.labelKey) }) })
                ] }, cat.category);
              }) })
            ] }) }) })
          ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "adjustments", className: "space-y-6 mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: adjustments.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center py-8 text-sm text-muted-foreground font-medium", children: t("budgets.no_adjustments") }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: adjustments.map((adj) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 rounded-xl border border-border bg-card/50", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: `text-[8px] font-black border-0 ${adj.status === "approved" ? "bg-green-100 text-green-700" : adj.status === "pending" ? "bg-yellow-100 text-yellow-700" : "bg-red-100 text-red-700"}`, children: adj.status === "approved" ? t("budgets.status_approved") : adj.status === "pending" ? t("budgets.status_pending") : t("budgets.status_rejected") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground", children: formatDate(adj.createdAt) })
          ] })
        ] }, adj.id)) }) })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "forecast", className: "space-y-6 mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: forecast.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center py-8 text-sm text-muted-foreground font-medium", children: t("budgets.forecast_no_data") }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-4", children: forecast.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "border-l-4 border-l-primary", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground", children: f.label }),
      ...
      Modal,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("budgets.budget_type") }),
          ...
          formData.budgetType !== "business" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: formData.budgetType === "department" ? t("budgets.department_name") : formData.budgetType === "project" ? t("budgets.project_name") : t("budgets.branch_name") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("budgets.category") }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("budgets.planned_amount") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                type: "number",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("budgets.period") }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("budgets.period_month") }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "isRecurring", className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("budgets.recurring_label") })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("budgets.notes_label") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
              {
      ...
      Modal,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-xl bg-muted/30", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground font-medium", children: t("budgets.current_budget") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("budgets.new_amount") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                id: "adjAmount",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("budgets.adjustment_reason") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "textarea",
              {
                id: "adjReason",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Modal,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 py-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("budgets.target_month") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "select",
                {
                  id: "dupMonth",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("budgets.target_year") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "select",
                {
                  id: "dupYear",
