import { c as createLucideIcon, r as reactExports, aP as useComposedRefs, al as useDirection, j as jsxRuntimeExports, ah as Primitive, aR as Presence, an as createContextScope, ai as composeEventHandlers, aS as useCallbackRef, aT as useLayoutEffect2, ao as cn, b as useSettings, o as useAuth, m as Package, V as Input, g as Badge, e as Button, aU as ChevronRight, T as TriangleAlert, t as toast } from "./index-DQvMvM6p.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-DSqMyoyu.js";
import { C as Card, a as CardHeader, b as CardTitle, d as CardDescription, c as CardContent } from "./card-MD6aRxed.js";
import { L as Label } from "./label-CRpD9KNw.js";
import { e as clamp, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-LYbu3WYR.js";
              ...
              history.filter((h) => h.itemName.toLowerCase().includes(searchQuery.toLowerCase())).map((h, i) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border hover:bg-muted/30 transition-colors", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-6 py-4 font-medium whitespace-nowrap text-foreground", children: [
                    formatDate(h.date),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground", children: formatTime(h.createdAt ? new Date(h.createdAt) : /* @__PURE__ */ new Date()) })
                  ] }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 text-center", children: h.reversalId ? /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "bg-muted/50 text-muted-foreground border-border font-bold text-[10px]", children: t("adjustments.reversed_badge") || "Reversed" }) : hasPermission("adjustments.reverse") ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      variant: "ghost",
                      size: "sm",
