import { c as createLucideIcon, b as useSettings, r as reactExports, j as jsxRuntimeExports, l as TrendingDown, T as TriangleAlert, g as Badge, ag as ChartPie, ae as CreditCard, m as Package, ar as Shield, h as Clock, k as ChartColumn } from "./index-fMHJoXSU.js";
...
import { B as Briefcase, A as AreaChart, a as Area } from "./AreaChart-DIybDEpD.js";
...
import { an as ResponsiveContainer, al as CartesianGrid, am as XAxis, ak as Tooltip } from "./CartesianChart-En-wnclD.js";
import { Y as YAxis, B as BarChart, c as Bar, A as Activity } from "./BarChart-DfWA8j-6.js";
import { B as Boxes } from "./boxes-B6FPUt1I.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-in pb-24 relative min-h-screen bg-background text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 md:px-8 lg:px-12 max-w-[1800px] mx-auto flex flex-col gap-y-8 pt-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-3xl shadow-sm flex flex-col relative overflow-hidden group border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs font-bold uppercase tracking-wider mb-1", children: t("analytics.expenses_today").replace(
          "Today",
          t(`analytics.${period}`)
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-2xl font-bold tracking-tight text-foreground", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-3xl shadow-sm flex flex-col relative overflow-hidden group border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs font-bold uppercase tracking-wider mb-1 relative z-10", children: t("analytics.net_today").replace(
          "Today",
          t(`analytics.${period}`)
        ) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-3xl shadow-sm flex flex-col border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 md:p-8", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-[300px] w-full", children: chartData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col items-center justify-center text-center text-muted-foreground", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest", children: t("analytics.no_sales_data") }),
            ...
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-medium text-muted-foreground mt-0.5", children: [
