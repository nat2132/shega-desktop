import { c as createLucideIcon, b as useSettings, r as reactExports, j as jsxRuntimeExports, a7 as TrendingDown, T as TriangleAlert, g as Badge, a4 as CreditCard, P as Package, ag as Shield, p as Clock, i as ChartColumn } from "./index-1f1mrYRP.js";
import { C as Card, c as CardContent, L as Label } from "./label-CasNofhH.js";
...
import { B as Briefcase, C as ChartPie, A as AreaChart, a as Area } from "./AreaChart-B070WWds.js";
import { Z as Zap, Y as YAxis, B as BarChart, c as Bar, A as Activity } from "./BarChart-N_uNEIwU.js";
import { B as Banknote } from "./banknote-SrouR-Tm.js";
import { A as ArrowRightLeft } from "./arrow-right-left-BZVHPGjy.js";
import { ai as ResponsiveContainer, ag as CartesianGrid, ah as XAxis, af as Tooltip } from "./CartesianChart-B0KVa_vB.js";
import { B as Boxes } from "./boxes-C6raedRF.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-in pb-24 relative min-h-screen bg-background text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 md:px-8 lg:px-12 max-w-[1800px] mx-auto flex flex-col gap-y-8 pt-8", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-3xl shadow-sm border-border bg-gradient-to-t from-primary/5 to-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold tracking-tight text-foreground", children: "Payment Methods" })
      ] }),
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
              ...
              isPredominant && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold uppercase text-primary tracking-wider", children: "Most used" })
            ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-[250px] w-full", children: salesDistribution.data.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-full flex flex-col items-center justify-center text-center text-muted-foreground", children: [
        ...
        BarChart,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "revenue", name: "Revenue", fill: "url(#colorDist)", radius: [4, 4, 0, 0], maxBarSize: 30 })
          ]
        }
      ) }) })
    ] }) }),
