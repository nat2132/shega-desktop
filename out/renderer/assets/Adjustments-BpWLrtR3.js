import { c as createLucideIcon, r as reactExports, aD as useComposedRefs, ad as useDirection, j as jsxRuntimeExports, a9 as Primitive, aF as Presence, af as createContextScope, aa as composeEventHandlers, aG as useCallbackRef, aH as useLayoutEffect2, k as cn, b as useSettings, m as useAuth, a5 as History, P as Package, K as Input, g as Badge, e as Button, aI as ChevronRight, T as TriangleAlert, t as toast } from "./index-KcbOuwlA.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-Llxhc1yS.js";
import { C as Card, a as CardHeader, b as CardTitle, d as CardDescription, c as CardContent, L as Label } from "./label-BI69aa1I.js";
import { e as clamp, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-YJnyGvXs.js";
              ...
              history.filter((h) => h.itemName.toLowerCase().includes(searchQuery.toLowerCase())).map((h, i) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border hover:bg-muted/30 transition-colors", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-6 py-4 font-medium whitespace-nowrap text-foreground", children: [
                    formatDate(h.date),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground", children: new Date(h.createdAt).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) })
                  ] }),
