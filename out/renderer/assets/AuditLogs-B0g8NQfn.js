import { b as useSettings, r as reactExports, j as jsxRuntimeExports, ag as Shield, a1 as Search, K as Input, e as Button, F as Filter, R as RefreshCw, g as Badge, w as Eye, t as toast } from "./index-KcbOuwlA.js";
      ...
      logs.map((log, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 hover:bg-muted/10 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground ml-auto", children: log.createdAt ? new Date(log.createdAt).toLocaleString() : "" })
          ] }),
