import { c as createLucideIcon, a2 as useParams, d as useNavigate, b as useSettings, m as useAuth, r as reactExports, t as toast, j as jsxRuntimeExports, e as Button, g as Badge, h as Trash2, s as Receipt, a3 as Separator, $ as User, a4 as CreditCard, a5 as History, Q as Dialog, U as DialogContent, W as DialogHeader, Y as DialogTitle, Z as DialogDescription, K as Input, _ as DialogFooter, V as DialogClose, M as Modal } from "./index-1f1mrYRP.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardContent, d as CardDescription, L as Label } from "./label-CasNofhH.js";
import { A as AlertDialog, h as AlertDialogTrigger, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel, g as AlertDialogAction } from "./alert-dialog-BfirtEch.js";
import { P as Printer } from "./printer-B7XlyrfD.js";
import { S as SquarePen } from "./square-pen-FQXOOXtq.js";
import { U as Undo2 } from "./undo-2-RnfvQB2n.js";
...
const SaleDetail = () => {
  ...
  if (!sale) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-[60vh]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm font-bold uppercase tracking-widest", children: "Sale not found" }) });
  }
        ...
        hasPermission("sales.void") && sale && sale.status !== "Voided" && /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialog, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogContent, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogDescription, { children: "This will restore inventory and mark the sale as voided. This action cannot be undone." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-2 block", children: "Reason for voiding" }),
