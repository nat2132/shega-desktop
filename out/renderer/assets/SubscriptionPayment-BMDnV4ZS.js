import { c as createLucideIcon, b as useSettings, d as useNavigate, bz as useSubscription, r as reactExports, j as jsxRuntimeExports, aa as ArrowLeft, e as Button, S as Sparkles, bA as PremiumBadge, g as Badge, bD as CheckCheck, aW as Copy, ax as Building2, ad as CreditCard, V as Input, L as LoaderCircle, aw as Check, t as toast } from "./index-DQvMvM6p.js";
import { C as Card, c as CardContent, a as CardHeader, b as CardTitle, d as CardDescription } from "./card-MD6aRxed.js";
...
const SubscriptionPayment = () => {
  ...
  if (step === "select") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 p-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => navigate("/subscription"), className: "flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest text-muted-foreground hover:text-foreground transition-colors", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-semibold uppercase tracking-widest text-muted-foreground", children: t("subscription.compare_plans") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          ...
          plans.filter((p) => p.tier === "basic").map((plan) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-2xl border-border/50 cursor-pointer hover:border-primary/30 transition-all", onClick: () => handleSelectPlan(plan), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground mb-1", children: plan.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-3xl font-black", children: [
              plan.price.toLocaleString(),
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground font-bold", children: "ETB" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground mt-2", children: plan.description }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: "mt-4 rounded-xl text-[10px] font-black uppercase tracking-widest w-full", children: t("subscription.choose_plan") })
          ] }) }, plan.id))
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          ...
          plans.filter((p) => p.tier === "premium").map((plan) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-2xl border-amber-500/20 bg-gradient-to-b from-amber-500/[0.02] to-transparent cursor-pointer hover:border-amber-500/40 transition-all", onClick: () => handleSelectPlan(plan), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-amber-500", children: plan.name }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground mt-2", children: plan.description }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", className: "mt-4 rounded-xl text-[10px] font-black uppercase tracking-widest w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700", children: t("subscription.choose_plan") })
          ] }) }, plan.id))
        ] })
      ] })
    ] });
  ...
  if (step === "pay") {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 p-6 max-w-2xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setStep("select"), className: "flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest text-muted-foreground hover:text-foreground transition-colors", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "h-3 w-3" }),
        t("back") || "Back"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-lg font-black uppercase tracking-tight", children: t("subscription.billing") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-semibold uppercase tracking-widest text-muted-foreground", children: selectedPlan?.name })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-2xl border-border/50 bg-gradient-to-b from-primary/[0.02] to-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: t("subscription.payment_instruction_desc") })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 rounded-2xl bg-muted/30 border border-border/50 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground", children: t("subscription.payment_method") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[8px] font-black uppercase tracking-widest bg-emerald-500/10 text-emerald-500 border-emerald-500/20", children: t("subscription.telebirr") })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-3 rounded-xl bg-muted/20 border border-border/50", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: copyNumber, className: "flex items-center gap-1 text-[9px] font-black uppercase tracking-widest text-primary hover:text-primary/80 transition-colors", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "rounded-2xl border-border/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { className: "p-5 pb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-[10px] font-black uppercase tracking-widest flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CreditCard, { className: "h-3.5 w-3.5" }),
            t("subscription.submit_payment")
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-[10px]", children: t("subscription.pending_verification") })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-5 pt-2 space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground mb-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground mb-1.5", children: t("subscription.payment_date") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                type: "date",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground mb-1.5", children: t("subscription.optional_notes") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              disabled: submitting,
              className: "w-full rounded-xl text-[10px] font-black uppercase tracking-widest bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 mt-2",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6 p-6 max-w-lg mx-auto text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-16", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-amber-500 font-bold", children: t("subscription.pending_verification") }),
