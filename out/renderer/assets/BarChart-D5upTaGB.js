import { c as createLucideIcon, r as reactExports, a as clsx, ah as getDefaultExportFromCjs } from "./index-KcbOuwlA.js";
import { aj as withPath, ak as constant, al as svgPropertiesAndEvents, N as isNumber, am as upperFirst, B as resolveDefaultProps, I as useAnimationId, an as getTransitionVal, J as JavascriptAnimate, ao as roundTemplateLiteral, M as interpolate, L as Layer, a2 as Curve, ap as Sector, aq as Rectangle, a5 as useAppDispatch, ar as setActiveMouseOverItemIndex, as as mouseLeaveItem, at as setActiveClickItemIndex, au as isStacked, av as isNullish, $ as getPercentValue, aw as isWellBehavedNumber, ax as getStackSeriesIdentifier, c as createSelector, A as selectChartOffsetInternal, ay as selectAxisViewBox, o as selectChartLayout, az as selectChartDataWithIndexesIfNotInPanoramaPosition3, aA as selectXAxisIdFromGraphicalItemId, aB as selectAxisWithScale, aC as selectYAxisIdFromGraphicalItemId, aD as selectTicksOfGraphicalItem, aE as getBandSizeOfAxis, aF as selectUnfilteredCartesianItems, aG as selectRootMaxBarSize, aH as selectBarGap, aI as selectBarCategoryGap, aJ as selectStackGroups, aK as selectRootBarSize, aL as selectCartesianAxisSize, aM as getNormalizedStackId, aN as propsAreEqual, D as DefaultZIndexes, aO as useIsPanorama, R as RegisterGraphicalItemId, aP as SetLegendPayload, aQ as SetCartesianGraphicalItem, Z as ZIndexLayer, z as getTooltipNameProp, H as SetTooltipEntrySettings, aR as noop, aS as useNeedsClip, aT as useChartLayout, E as findAllByType, F as useAppSelector, h as getValueByDataKey, aU as GraphicalItemClipPath, aV as getBaseValueOfBar, aW as truncateByDomain, aX as getCateCoordinateOfBar, Q as selectActiveTooltipIndex, a1 as svgPropertiesNoEventsFromUnknown, X as adaptEventsOfChild, Y as LabelListFromLabelProp, aY as CartesianLabelListContextProvider, C as svgPropertiesNoEvents, T as selectActiveTooltipDataKey, aZ as isNan, O as mathSign, a_ as axisPropsAreEqual, a$ as implicitYAxis, b0 as defaultCartesianAxisProps, b1 as useCartesianChartLayout, b2 as addYAxis, b3 as replaceYAxis, b4 as removeYAxis, b5 as selectYAxisSize, b6 as selectYAxisPosition, b7 as selectTicksOfAxis, b8 as selectYAxisSettingsNoDefaults, b9 as isLabelContentAFunction, ba as updateYAxisWidth, bb as CartesianAxis, bc as getAxisTypeBasedOnLayout, bd as CartesianChart, ae as arrayTooltipSearcher } from "./CartesianChart-ljR0iKyw.js";
/**
...
var isPlainObject = isPlainObject$3.isPlainObject;
...
function BarBackground(props) {
  ...
  return /* @__PURE__ */ reactExports.createElement(ZIndexLayer, {
    ...
    var {
      ...
      tooltipPosition
    } = entry, rest = _objectWithoutProperties$1(entry, _excluded2$1);
...
function BarRectangles(_ref3) {
  ...
  var _ref4 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(props)) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {}, {
    id
  } = _ref4, baseProps = _objectWithoutProperties$1(_ref4, _excluded3$1);
  var {
    shape,
    dataKey,
    activeBar
