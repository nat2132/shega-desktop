import { c as createLucideIcon, g as useSettings, O as useAuth, r as reactExports, j as jsxRuntimeExports, ai as Search, G as Input, i as Button, x as Plus, a2 as Sheet, a3 as SheetTrigger, a4 as Filter, m as Badge, a5 as SheetContent, a6 as SheetHeader, a7 as SheetTitle, a8 as SheetDescription, a9 as SheetFooter, aa as SheetClose, ah as React, ay as DropdownMenu, az as DropdownMenuTrigger, aB as DropdownMenuContent, a$ as DropdownMenuItem, T as TriangleAlert, ap as History, aA as ChevronDown, M as Modal, X, w as ShoppingCart, H as toast } from "./index-wvHtiMql.js";
...
import { C as ChevronUp, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-iyCsL0f8.js";
...
import { C as CircleDollarSign } from "./circle-dollar-sign-D_jgD3e0.js";
...
const DebtManagement = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 py-4 md:gap-6 md:py-6 fade-in", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionCards, { cards: kpiCards, storageKey: "debts" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 lg:px-6 space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", onClick: openAddDebt, className: "h-8 px-3 shadow-md shadow-primary/20", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-8 p-6 flex-1 overflow-y-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(DatePicker, { value: filterStartDate, onChange: setFilterStartDate, className: "bg-muted/30 border-border/50 rounded-xl text-xs w-full [&>div]:w-full [&>div>button]:flex-1 [&>div>button]:min-w-0" })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(DatePicker, { value: filterEndDate, onChange: setFilterEndDate, className: "bg-muted/30 border-border/50 rounded-xl text-xs w-full [&>div]:w-full [&>div>button]:flex-1 [&>div>button]:min-w-0" })
                ] })
              ] })
            ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Modal,
      {
        ...
        title: t("debt.add_debt", "Add Debt"),
        size: "md",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleAddDebt, className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: addForm.itemId, onValueChange: (v) => {
              const item = items.find((i) => i.id === parseInt(v));
              setAddForm({ ...addForm, itemId: v, price: item?.baseSellingPrice?.toString() || "" });
            }, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-10 bg-muted/30 border-border/50 rounded-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: t("debt.select_item", "Select item") }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "rounded-xl", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectItem, { value: String(item.id), children: [
                item.name,
                " (",
                item.baseUnit,
                ") — ",
                t("common.etb"),
                " ",
                Number(item.baseSellingPrice).toLocaleString()
              ] }, item.id)) })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground", children: t("debt.due_date", "Due Date") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DatePicker, { value: addForm.dueDate, onChange: (v) => setAddForm({ ...addForm, dueDate: v }), className: "w-full" })
          ] }),
          addForm.itemId && addForm.price && addForm.quantity && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl bg-primary/10 p-3 flex justify-between items-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-black uppercase tracking-widest text-primary", children: t("debt.amount") }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-lg font-black text-primary", children: [
              t("common.etb"),
              " ",
              ((parseFloat(addForm.price) || 0) * (parseFloat(addForm.quantity) || 1)).toLocaleString()
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 pt-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "outline", onClick: () => setShowAddModal(false), className: "flex-1", children: t("common.cancel", "Cancel") }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { type: "submit", className: "flex-1", children: [
