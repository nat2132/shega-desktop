import { c as createLucideIcon, b as useSettings, r as reactExports, j as jsxRuntimeExports, g as Badge, e as Button, S as Sheet, x as SheetTrigger, F as Filter, y as SheetContent, z as SheetHeader, A as SheetTitle, D as SheetDescription, G as SheetFooter, H as SheetClose, M as Modal, a4 as CreditCard, a5 as History, K as Input, h as Trash2, t as toast } from "./index-1f1mrYRP.js";
import { E, b as addPdfHeader, c as autoTable } from "./export-utils-DJTtd_HY.js";
import { S as SectionCards } from "./section-cards-B3p3Y0u_.js";
import { D as DataTable } from "./data-table-OlLEHJ50.js";
import { T as Textarea } from "./textarea-0A94trOT.js";
...
import { P as Pencil } from "./pencil-CG2hwS_O.js";
import { P as Printer } from "./printer-B7XlyrfD.js";
import { P as Phone } from "./phone-DiHvBrbE.js";
import { M as Mail } from "./mail-BvN-vQpt.js";
import { M as MapPin } from "./map-pin-CT4rBA8P.js";
import { S as Save } from "./save-DovJtZVF.js";
import "./table-CKEwQckQ.js";
import "./tabs-D04kOB_W.js";
/**
  ...
  const columns = [
      ...
      cell: ({ row }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: row.original.phone || t("sales.walk_in") }),
            row.original.groupName !== "general" && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-[9px] h-4 px-1", children: row.original.groupName })
          ] })
        ] })
      ] })
    },
    ...
    },
    {
      ...
      cell: ({ row }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-end gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", onClick: () => openEditCustomer(row.original), title: "Edit Profile", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { size: 14 }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open: isFilterOpen, onOpenChange: setIsFilterOpen, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: `h-8 px-3 transition-all ${filterGroup !== "All" || filterCity !== "All" || filterStatus !== "All" ? "border-primary text-primary bg-primary/5 shadow-sm" : "border-border/60 hover:bg-muted/50"}`, children: [
            ...
            "Filters ",
            (filterGroup !== "All" || filterCity !== "All" || filterStatus !== "All") && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "ml-1.5 h-4 px-1 text-[9px] rounded-full", children: "Active" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "right", className: "w-[400px] sm:w-[540px] border-l-border/40 p-0 flex flex-col", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetHeader, { className: "border-b border-border/50 p-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { className: "text-2xl font-black uppercase tracking-tight", children: "Customer Filters" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(SheetDescription, { className: "text-[10px] font-bold text-muted-foreground uppercase tracking-widest", children: "Refine your customer view" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 p-6 flex-1 overflow-y-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-primary", children: "Group" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: filterGroup, onValueChange: setFilterGroup, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-12 bg-muted/30 border-border/50 rounded-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "All Groups" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "rounded-xl", children: uniqueGroups.map((g) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: g, children: g }, g)) })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-primary", children: "City" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: filterCity, onValueChange: setFilterCity, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-12 bg-muted/30 border-border/50 rounded-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "All Cities" }) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[10px] font-black uppercase tracking-[0.3em] text-primary", children: "Status" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: filterStatus, onValueChange: setFilterStatus, children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-12 bg-muted/30 border-border/50 rounded-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "All Statuses" }) }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(SheetFooter, { className: "p-6 border-t border-border/50 bg-background/80 backdrop-blur-md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 w-full", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SheetClose, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "flex-1 py-3 font-black uppercase tracking-widest rounded-xl shadow-xl", children: "Apply Filters" }) })
            ] }) })
          ] })
        ] })
      ] }),
        ...
        children: selectedCustomer && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-xl bg-muted/30", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground", children: t("customers.master_balance") }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-xl bg-primary/10", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-primary", children: t("customers.lifetime_paid") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs bg-muted/20 p-2 rounded-lg", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[9px] h-4 px-1", children: selectedCustomer.groupName })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-xs bg-muted/20 p-2 rounded-lg", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", onClick: () => openEditCustomer(selectedCustomer), className: "h-8 text-[10px] font-bold uppercase tracking-widest", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Pencil, { size: 12, className: "mr-1" }),
            " Edit Profile"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground border-b border-border/50 pb-1.5 flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 max-h-32 overflow-y-auto my-2", children: [
              customerNotes.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground italic", children: "No notes recorded" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border rounded-lg overflow-hidden mt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/60 text-[9px] font-black uppercase tracking-widest", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { className: "text-xs", children: [
                customerSales.filter((s) => s.paymentStatus === "Debt").map((sale) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t border-border/40 hover:bg-muted/20", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-3 py-2 text-right flex justify-end gap-1", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", onClick: () => openPayment(sale), className: "h-6 text-[9px] font-bold uppercase tracking-widest px-2", children: t("customers.pay") })
                  ] })
                ] }, sale.id)),
                customerSales.filter((s) => s.paymentStatus === "Debt").length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 5, className: "px-3 py-4 text-center text-muted-foreground text-[10px]", children: "No outstanding debts" }) })
              ] })
            ] }) })
          ] })
        ] })
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSaveCustomer, className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: "Customer Name *" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  required: true,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: "Group" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: CUSTOMER_GROUPS.map((g) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: g, children: g }, g)) })
                  ]
                }
              )
            ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: "Secondary Phone" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: "Company" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: "Tax Number" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: "Notes" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Textarea,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 ml-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "outline", onClick: () => setShowFormModal(false), className: "h-8 text-[10px] font-bold uppercase tracking-widest px-3", children: "Cancel" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { type: "submit", className: "h-8 text-[10px] font-bold uppercase tracking-widest px-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Modal,
      {
        ...
        children: selectedSale && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handlePayment, className: "space-y-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("customers.payment_amount") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                required: true,
