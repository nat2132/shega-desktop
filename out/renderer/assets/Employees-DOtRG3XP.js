import { c as createLucideIcon, b as useSettings, r as reactExports, as as Users, a5 as History, j as jsxRuntimeExports, e as Button, a1 as Search, K as Input, R as RefreshCw, g as Badge, h as Trash2, M as Modal, t as toast } from "./index-BzfzhNvZ.js";
import { D as DatePicker } from "./DatePicker-CnRj8BWX.js";
import { S as ShieldCheck } from "./shield-check-B1IxLh8l.js";
import { U as UserPlus } from "./user-plus-1kbZalwi.js";
import { P as Pen } from "./pen-BrK1SFCb.js";
import { P as Plus } from "./plus-pfyf3FTE.js";
...
const Employees = () => {
  ...
  const [logFilters, setLogFilters] = reactExports.useState({ employeeId: 0, action: "" });
  ...
  const tabs = [
    ...
    { id: "logs", label: t("employees.activity_logs"), icon: History }
  ];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 py-4 md:gap-6 md:py-6 fade-in", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 lg:px-6", children: [
      activeTab === "employees" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 flex-wrap", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", className: "h-9 text-[10px] font-black uppercase tracking-widest", onClick: loadEmployees, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { size: 14, className: "mr-2" }),
            " ",
            t("employees.refresh")
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "h-9 px-5 text-[10px] font-black uppercase tracking-widest", onClick: openCreateEmployee, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border bg-card/40 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
            employees.map((emp) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/20 hover:bg-muted/20 transition-colors", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-[10px] font-semibold", children: emp.employeeCode || "-" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "p-4", children: [
                ...
                emp.email && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-muted-foreground", children: emp.email })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-[10px] font-semibold", children: emp.phone || "-" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-[9px] font-black", children: emp.roleName || "-" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: emp.hasAccount ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "default", className: "text-[9px] font-black", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(LogIn, { size: 10, className: "mr-1" }),
                " ",
                t("employees.has_account")
              ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[9px] font-black", children: t("employees.no_account") }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: emp.isActive ? "default" : "secondary", className: "text-[9px] font-black uppercase", children: emp.isActive ? t("employees.active") : t("employees.inactive") }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "sm", className: "h-7 text-[9px] font-black uppercase tracking-widest", onClick: () => openEditEmployee(emp), children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Pen, { size: 11, className: "mr-1" }),
                  " ",
                  t("employees.edit")
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "sm", className: "h-7 text-[9px] font-black uppercase tracking-widest text-destructive", onClick: () => {
                  setDeleteTarget(emp);
            ...
            employees.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 7, className: "p-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("employees.no_employees") }) }) })
          ] })
        ] }) }) })
      ] }),
      activeTab === "roles" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "h-9 px-5 text-[10px] font-black uppercase tracking-widest", onClick: openCreateRole, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4", children: [
          roles.map((role) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 rounded-2xl border-2 bg-card/40 border-muted hover:border-muted-foreground/30 transition-all group", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    role.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-muted-foreground font-bold uppercase mt-0.5", children: role.description })
                  ] })
                ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-4 pt-3 border-t border-border/30", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "h-7 text-[9px] font-black uppercase tracking-widest", onClick: () => openEditRole(role), children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Pen, { size: 11, className: "mr-1" }),
                  " ",
                  t("employees.edit")
                ] }),
                !role.isSystem && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "h-7 text-[9px] font-black uppercase tracking-widest text-destructive", onClick: () => handleDeleteRole(role.id), children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 11, className: "mr-1" }),
                  " ",
                  t("employees.delete")
                ] })
          ...
          roles.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-full p-12 text-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("employees.no_roles") })
          ] })
        ] })
      ] }),
      activeTab === "accounts" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "h-9 px-5 text-[10px] font-black uppercase tracking-widest", onClick: openCreateAccount, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
            accounts.map((acct) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/20 hover:bg-muted/20 transition-colors", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "p-4", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-muted-foreground", children: acct.employeeCode || "" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-[10px] font-semibold", children: acct.username }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-[10px] font-semibold", children: acct.lastLogin ? formatDateTime(acct.lastLogin) : "-" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: acct.isActive ? "default" : "secondary", className: "text-[9px] font-black uppercase", children: acct.isActive ? t("employees.active") : t("employees.inactive") }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "sm", className: "h-7 text-[9px] font-black uppercase tracking-widest", onClick: () => openEditAccount(acct), children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Pen, { size: 11, className: "mr-1" }),
                  " ",
                  t("employees.edit")
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "sm", className: "h-7 text-[9px] font-black uppercase tracking-widest text-destructive", onClick: () => handleDeleteAccount(acct.id), children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Trash2, { size: 11, className: "mr-1" }),
                  " ",
                  t("employees.delete")
                ] })
            ...
            accounts.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 5, className: "p-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("employees.no_accounts") }) }) })
          ] })
        ] }) }) })
      ] }),
      activeTab === "logs" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
                ...
                className: "h-9 px-3 rounded-xl border bg-background text-xs font-bold",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: 0, children: t("employees.all_employees") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border bg-card/40 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/50 text-[9px] font-black uppercase tracking-widest text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4", children: t("employees.date") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4", children: t("employees.employee") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4", children: t("employees.action") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4", children: t("employees.entity") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "p-4", children: t("employees.details") })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
            logs.map((log) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/20 hover:bg-muted/20 transition-colors", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-[10px] font-semibold", children: formatDateTime(log.createdAt) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-[10px] font-semibold", children: log.firstName ? `${log.firstName} ${log.lastName}` : "-" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[9px] font-black uppercase", children: log.action }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: log.entityType ? `${log.entityType}${log.entityId ? ` #${log.entityId}` : ""}` : "-" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-[10px] text-muted-foreground max-w-[300px] truncate", title: log.details, children: log.details || "-" })
            ] }, log.id)),
            logs.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 5, className: "p-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("employees.no_logs") }) }) })
          ] })
        ] }) }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showEmployeeModal, onClose: () => setShowEmployeeModal(false), title: editingEmployee ? t("employees.edit_employee") : t("employees.new_employee"), size: "md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("employees.employee_code") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("employees.role") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "select",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("employees.phone") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("employees.email_label") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("employees.hire_date") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "flex-1 h-12 font-black uppercase text-[10px] tracking-widest", onClick: handleSaveEmployee, children: editingEmployee ? t("employees.update") : t("employees.create") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", className: "flex-1 h-12 font-black uppercase text-[10px] tracking-widest", onClick: () => setShowEmployeeModal(false), children: t("common.cancel") })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showRoleModal, onClose: () => setShowRoleModal(false), title: editingRole ? t("employees.edit_role") : t("employees.new_role"), size: "md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("employees.description") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("employees.permissions") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 gap-2 p-3 rounded-xl border", children: allPermissionOptions.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex items-center gap-2 cursor-pointer", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-semibold uppercase", children: p })
        ] }, p)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "flex-1 h-12 font-black uppercase text-[10px] tracking-widest", onClick: handleSaveRole, children: editingRole ? t("employees.update") : t("employees.create") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", className: "flex-1 h-12 font-black uppercase text-[10px] tracking-widest", onClick: () => setShowRoleModal(false), children: t("common.cancel") })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showAccountModal, onClose: () => setShowAccountModal(false), title: editingAccount ? t("employees.edit_account") : t("employees.new_account"), size: "sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "flex-1 h-12 font-black uppercase text-[10px] tracking-widest", onClick: handleSaveAccount, children: editingAccount ? t("employees.update") : t("employees.create") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", className: "flex-1 h-12 font-black uppercase text-[10px] tracking-widest", onClick: () => setShowAccountModal(false), children: t("common.cancel") })
      ] })
    ] }) }),
    deleteTarget && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50", onClick: () => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-semibold text-muted-foreground mt-3", children: t("employees.delete_desc").replace("{name}", `${deleteTarget.firstName} ${deleteTarget.lastName}`) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mt-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "destructive", className: "flex-1 h-11 text-[10px] font-black uppercase tracking-widest", onClick: handleDeleteEmployee, children: t("employees.delete") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", className: "flex-1 h-11 text-[10px] font-black uppercase tracking-widest", onClick: () => {
          setShowDeleteConfirm(false);
          setDeleteTarget(null);
