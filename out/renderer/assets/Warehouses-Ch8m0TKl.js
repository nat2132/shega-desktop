import { b as useSettings, r as reactExports, az as Building2, m as Package, j as jsxRuntimeExports, g as Badge, e as Button, aE as Warehouse, a7 as User, y as Trash2, ap as cn, a9 as Search, V as Input, R as RefreshCw, M as Modal, _ as toast } from "./index-fMHJoXSU.js";
import { A as AlertDialog, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel, g as AlertDialogAction } from "./alert-dialog-5x8ZnzIT.js";
import { A as ArrowRightLeft } from "./arrow-right-left-DSjXlqux.js";
import { H as History } from "./history-BUJMTkJI.js";
import { P as Plus } from "./plus-DnJWnBIF.js";
import { P as Phone } from "./phone-BVCbc8eV.js";
import { P as Pen } from "./pen-C3tMN52r.js";
const Warehouses = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 py-4 md:gap-6 md:py-6 fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 lg:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-3", children: kpiCards.map((card, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 rounded-2xl border bg-card/40", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: card.title }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: card.trendType === "up" ? "default" : "destructive", className: "text-xs font-black uppercase", children: card.trendType === "up" ? "+0%" : "0%" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground font-bold", children: card.footerTitle })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: card.footerSub })
    ] }, i)) }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 lg:px-6", children: [
      activeTab === "warehouses" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "h-9 px-5 text-xs font-black uppercase tracking-widest", onClick: openCreateWh, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4", children: [
          warehouses.map((wh) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: cn(
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-bold uppercase mt-0.5", children: wh.location || t("warehouses.no_warehouse_location") })
                ] })
              ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 space-y-1.5", children: [
              wh.managerName && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs font-semibold text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 12 }),
                " ",
                wh.managerName
              ] }),
              wh.managerPhone && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-xs font-semibold text-muted-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mt-4 pt-3 border-t border-border/30 opacity-0 group-hover:opacity-100 transition-opacity", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "h-7 text-xs font-black uppercase tracking-widest", onClick: () => openEditWh(wh), children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Pen, { size: 11, className: "mr-1" }),
                " ",
                t("warehouses.edit_warehouse")
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "h-7 text-xs font-black uppercase tracking-widest text-destructive hover:text-destructive", onClick: () => {
                setDeleteTarget(wh);
          ...
          warehouses.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-full p-12 text-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("warehouses.no_warehouses") }),
      ...
      activeTab === "inventory" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 flex-wrap", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", className: "h-9 text-xs font-black uppercase tracking-widest", onClick: () => {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
            (searchQuery ? inventory.filter(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "p-4", children: [
                ...
                inv.companyName && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: inv.companyName })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-xs font-semibold", children: inv.categoryName || "-" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: inv.quantity < 10 ? "destructive" : "default", className: "text-xs font-black", children: inv.quantity || 0 }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-xs font-semibold", children: inv.baseUnit || "pcs" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "p-4 text-xs font-semibold", children: [
                "ETB ",
                inv.baseSellingPrice?.toLocaleString() || 0
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "p-4 text-xs font-black", children: [
                "ETB ",
                ((inv.quantity || 0) * (inv.baseSellingPrice || 0)).toLocaleString()
              ] })
            ] }, inv.id)),
            inventory.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 6, className: "p-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("warehouses.no_inventory") }) }) })
          ] })
        ] }) }) })
      ] }),
      activeTab === "transfers" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("warehouses.transfer_history") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "h-9 px-5 text-xs font-black uppercase tracking-widest", onClick: () => {
            setTransferForm({ fromWarehouseId: 0, toWarehouseId: 0, itemId: 0, quantity: 0, notes: "", transferredBy: "" });
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border bg-card/40 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
            transfers.map((tr) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/20 hover:bg-muted/20 transition-colors", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-xs font-semibold", children: formatDate(tr.createdAt) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs font-black", children: tr.fromWarehouseName }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "default", className: "text-xs font-black", children: tr.toWarehouseName }) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: tr.status === "completed" ? "default" : "secondary", className: "text-xs font-black uppercase", children: tr.status }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-xs text-muted-foreground", children: tr.notes || "-" })
            ] }, tr.id)),
            transfers.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 7, className: "p-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("warehouses.no_transfers") }) }) })
          ] })
        ] }) }) })
      ] }),
      activeTab === "movements" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 flex-wrap", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", className: "h-9 text-xs font-black uppercase tracking-widest", onClick: loadMovements, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { size: 14, className: "mr-2" }),
            " ",
            t("warehouses.refresh")
          ] })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border bg-card/40 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
            movements.map((mv) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border/20 hover:bg-muted/20 transition-colors", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-xs font-semibold", children: formatDateTime(mv.createdAt) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs font-black", children: mv.warehouseName }) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: mv.type === "transfer_in" ? "default" : mv.type === "transfer_out" ? "secondary" : "outline", className: "text-xs font-black uppercase", children: mv.type.replace("_", " ") }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-xs font-black", children: mv.quantity }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-xs text-muted-foreground", children: mv.referenceType || "-" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "p-4 text-xs text-muted-foreground max-w-[200px] truncate", title: mv.notes, children: mv.notes || "-" })
            ] }, mv.id)),
            movements.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 7, className: "p-12 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("warehouses.no_movements_recorded") }) }) })
          ] })
        ] }) }) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showWarehouseModal, onClose: () => setShowWarehouseModal(false), title: editingWh ? t("warehouses.edit_warehouse") : t("warehouses.new_warehouse"), size: "md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("warehouses.warehouse_location") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("warehouses.manager_name") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("warehouses.manager_phone") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: "Email" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "flex-1 h-12 font-black uppercase text-xs tracking-widest", onClick: handleSaveWarehouse, children: editingWh ? t("warehouses.update_warehouse") : t("warehouses.create_warehouse") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", className: "flex-1 h-12 font-black uppercase text-xs tracking-widest", onClick: () => setShowWarehouseModal(false), children: t("common.cancel") })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showTransferModal, onClose: () => setShowTransferModal(false), title: t("warehouses.transfer_stock"), size: "md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("warehouses.transferred_by") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("warehouses.notes") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "flex-1 h-12 font-black uppercase text-xs tracking-widest", onClick: handleTransfer, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRightLeft, { size: 14, className: "mr-2" }),
          " ",
          t("warehouses.execute_transfer")
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", className: "flex-1 h-12 font-black uppercase text-xs tracking-widest", onClick: () => setShowTransferModal(false), children: t("common.cancel") })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showAdjustModal, onClose: () => setShowAdjustModal(false), title: t("warehouses.set_inventory_qty"), size: "sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("warehouses.title") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("warehouses.item") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-black uppercase tracking-widest text-muted-foreground", children: t("warehouses.new_qty") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "flex-1 h-12 font-black uppercase text-xs tracking-widest", onClick: handleAdjustInventory, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Package, { size: 14, className: "mr-2" }),
          " ",
          t("warehouses.set_quantity")
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", className: "flex-1 h-12 font-black uppercase text-xs tracking-widest", onClick: () => setShowAdjustModal(false), children: t("common.cancel") })
      ] })
    ] }) }),
