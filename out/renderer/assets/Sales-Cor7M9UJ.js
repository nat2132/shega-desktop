import { b as useSettings, j as jsxRuntimeExports, $ as Dialog, a0 as DialogContent, a1 as DialogClose, X, a2 as DialogHeader, a3 as DialogTitle, a4 as DialogDescription, a5 as DialogFooter, e as Button, Z as Download, Y as ShoppingCart, r as reactExports, v as ShoppingBag, a6 as User, g as Badge, y as Eye, n as Trash2, z as Sheet, D as SheetTrigger, F as Filter, G as SheetContent, H as SheetHeader, J as SheetTitle, K as SheetDescription, N as SheetFooter, O as SheetClose, Q as FileText, M as Modal, a7 as React, a8 as Search, V as Input, t as toast, _ as playSound } from "./index-DQvMvM6p.js";
import { E, e as exportCSV, a as exportPDF } from "./export-utils-CXBpemmh.js";
...
import { A as AlertDialog, h as AlertDialogTrigger, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel, g as AlertDialogAction } from "./alert-dialog-9cJF6vjK.js";
...
import { U as Undo2 } from "./undo-2-Bw5J-v-Z.js";
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: ({ row }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        row.original.status === "Voided" && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", className: "text-[8px] font-black uppercase", children: t("sales.voided_badge", "Voided") })
      ] })
    },
    {
      id: "actions",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 py-4 md:gap-6 md:py-6 fade-in", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-hidden flex flex-col", children: [
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    isOutOfStock ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground", children: t("sales.out_of_stock", "Out of Stock") }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Plus, { className: "h-4 w-4 text-muted-foreground opacity-0 group-hover:opacity-100" })
                  ]
                },
                item.id
              );
        ...
        currentStep === 2 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 p-8 space-y-6 flex flex-col items-center overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-4xl pt-4 flex gap-3 shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "secondary", className: "h-10 text-[10px] font-black uppercase tracking-widest rounded-xl", onClick: handleSaveDraft, children: t("sales.save_draft") }),
        ...
        currentStep === 3 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 p-8 space-y-6 overflow-y-auto custom-scrollbar flex flex-col items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-3xl space-y-6", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-2 flex flex-col gap-1.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", onClick: handleSaveDraft, className: "w-full h-9 text-[10px] font-black uppercase tracking-widest rounded-xl", disabled: cart.length === 0, children: t("sales.save_draft") }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showReceiptModal, onClose: () => setShowReceiptModal(false), title: t("sales.transaction_receipt"), size: "md", children: viewingSale && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-1 border-b border-dashed border-border pb-6", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("sales.receipt_id_label", "ID: #REC-{id}", { id: viewingSale.id }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showReturnModal, onClose: () => setShowReturnModal(false), title: t("sales.process_return", "Process Return"), size: "sm", children: returnSale && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleReturn, className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("sales.refund_amount") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            type: "number",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: t("sales.return_refund_hint", "Set to 0 for no refund (exchange only)") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground", children: t("sales.return_reason_label", "Reason") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            value: returnReason,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "button", variant: "outline", className: "flex-1 h-9 text-[10px] font-bold uppercase tracking-widest", onClick: () => setShowReturnModal(false), children: t("common.cancel") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", className: "flex-1 h-9 text-[10px] font-bold uppercase tracking-widest", disabled: !returnQty || parseFloat(returnQty) < 1, children: t("sales.process_return", "Process Return") })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showDraftsModal, onClose: () => setShowDraftsModal(false), title: t("sales.draft_sales"), size: "lg", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: drafts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-12 text-center text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold uppercase tracking-widest text-xs", children: t("sales.no_drafts") }) }) : drafts.map((draft) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 rounded-xl border border-border/60 bg-card/50 hover:bg-card transition-all", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5 shrink-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { size: "sm", variant: "outline", onClick: () => resumeDraft(draft.id), className: "h-7 text-[9px] font-bold uppercase tracking-widest px-2", children: t("sales.resume") }),
