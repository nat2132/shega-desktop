import { c as createLucideIcon, b as useSettings, m as useAuth, r as reactExports, j as jsxRuntimeExports, q as Truck, e as Button, B as Bell, as as Users, a1 as Search, K as Input, R as RefreshCw, g as Badge, w as Eye, aL as Archive, h as Trash2, aI as ChevronRight, a4 as CreditCard, an as Building2, p as Clock, M as Modal } from "./index-KcbOuwlA.js";
import { E, b as addPdfHeader, c as autoTable } from "./export-utils-Dojrgpyy.js";
import { A as AlertDialog, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel, g as AlertDialogAction } from "./alert-dialog-Ke03lX1F.js";
import { C as Card, c as CardContent, a as CardHeader, b as CardTitle, L as Label } from "./label-BI69aa1I.js";
...
import { D as DollarSign } from "./dollar-sign-D6OcZfWB.js";
import { T as TrendingUp } from "./trending-up-hKqHPSNy.js";
...
import { B as Ban } from "./ban-D9rtDD05.js";
...
const Suppliers = () => {
  ...
  const exportPDF = () => {
    ...
    doc.text(`Generated: ${(/* @__PURE__ */ new Date()).toLocaleDateString()}`, 14, y);
  ...
  if (view === "list") {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 p-2 fade-in", children: [
      toast && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `fixed bottom-4 right-4 z-50 px-4 py-2 rounded shadow ${toast.type === "success" ? "bg-green-600" : "bg-red-600"} text-white text-sm`, children: toast.message }),
