import { c as createLucideIcon, b as useSettings, r as reactExports, j as jsxRuntimeExports, a8 as Search, V as Input, e as Button, R as RefreshCw, i as Truck, a6 as User, A as ArrowRight, X, n as Trash2, M as Modal, h as Clock, g as Badge, t as toast } from "./index-DQvMvM6p.js";
import { D as DatePicker } from "./DatePicker-Csa48Niq.js";
import { P as Phone } from "./phone-mAlUW2fK.js";
import { C as CalendarDays } from "./calendar-days-BCwZ8IjQ.js";
import { P as Pen } from "./pen-35s8nzp1.js";
import { M as MapPin } from "./map-pin-YmErlmaZ.js";
import { C as CircleCheckBig } from "./circle-check-big-CU1SRzLr.js";
import { C as CircleX } from "./circle-x-B5t4BwKa.js";
...
const Shipments = () => {
  ...
  const StatusBadge = ({ status }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: config.variant, className: "text-[9px] font-black uppercase gap-1", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 py-4 md:gap-6 md:py-6 fade-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 lg:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", className: "h-9 text-[10px] font-black uppercase tracking-widest", onClick: loadShipments, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshCw, { size: 14, className: "mr-2" }),
        " ",
        t("shipments.refresh")
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "h-9 px-5 text-[10px] font-black uppercase tracking-widest", onClick: openCreate, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 lg:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4", children: [
      shipments.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 rounded-2xl border-2 bg-card/40 border-muted hover:border-muted-foreground/30 transition-all group cursor-pointer overflow-hidden", onClick: () => openDetail(s.id), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-muted-foreground font-bold uppercase mt-0.5", children: s.origin || t("shipments.no_origin") })
            ] })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 space-y-1.5", children: [
          s.driverName && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-[10px] font-semibold text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(User, { size: 12 }),
            " ",
            s.driverName
          ] }),
          s.driverPhone && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-[10px] font-semibold text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { size: 12 }),
            " ",
            s.driverPhone
          ] }),
          s.vehicleInfo && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-[10px] font-semibold text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Truck, { size: 12 }),
            " ",
            s.vehicleInfo
          ] }),
          s.scheduledDate && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-[10px] font-semibold text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarDays, { size: 12 }),
            " ",
            formatDate(s.scheduledDate)
          ] })
        ] }),
        s.notes && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-[9px] text-muted-foreground line-clamp-2", children: s.notes }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-4 pt-3 border-t border-border/30", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-muted-foreground font-bold", children: formatDate(s.createdAt) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity", onClick: (e) => e.stopPropagation(), children: [
            !["delivered", "cancelled"].includes(s.status) && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "h-7 text-[8px] font-black uppercase tracking-widest", onClick: () => {
            ...
            s.status === "pending" && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "outline", size: "sm", className: "h-7 text-[8px] font-black uppercase tracking-widest text-destructive", onClick: () => handleStatusChange(s.id, "cancelled"), children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(X, { size: 11, className: "mr-1" }),
              " ",
              t("shipments.cancel")
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", className: "h-7 text-[8px] font-black uppercase tracking-widest", onClick: () => openEdit(s), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Pen, { size: 11 }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", className: "h-7 text-[8px] font-black uppercase tracking-widest text-destructive", onClick: () => {
              setDeleteTarget(s);
      ...
      shipments.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "col-span-full p-12 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("shipments.no_shipments") }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showShipmentModal, onClose: () => setShowShipmentModal(false), title: editingShipment ? t("shipments.edit_shipment") : t("shipments.new_shipment"), size: "md", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("shipments.origin") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("shipments.driver_name") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("shipments.driver_phone") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("shipments.vehicle") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("shipments.scheduled_date") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("shipments.notes") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
            value: form.notes,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 pt-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { className: "flex-1 h-12 font-black uppercase text-[10px] tracking-widest", onClick: handleSave, children: editingShipment ? t("shipments.update") : t("shipments.create") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "outline", className: "flex-1 h-12 font-black uppercase text-[10px] tracking-widest", onClick: () => setShowShipmentModal(false), children: t("common.cancel") })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showDetailModal, onClose: () => setShowDetailModal(false), title: t("shipments.shipment_details"), size: "lg", children: selectedShipment && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          !["delivered", "cancelled"].includes(selectedShipment.status) && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", className: "h-8 text-[9px] font-black uppercase tracking-widest", onClick: () => {
          ...
          selectedShipment.status === "pending" && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "destructive", className: "h-8 text-[9px] font-black uppercase tracking-widest", onClick: () => handleStatusChange(selectedShipment.id, "cancelled"), children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 p-4 rounded-xl bg-muted/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground", children: t("shipments.route") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 p-4 rounded-xl bg-muted/20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground", children: t("shipments.driver_info") }),
      ...
      selectedShipment.scheduledDate && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-[10px] font-semibold text-muted-foreground", children: [
      ...
      selectedShipment.deliveredAt && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-[10px] font-semibold text-green-600", children: [
      ...
      selectedShipment.notes && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground", children: t("shipments.notes") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", children: selectedShipment.notes })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground", children: t("shipments.history") }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
          (selectedShipment.history || []).map((h) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-3 rounded-xl bg-muted/10", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] text-muted-foreground", children: formatDateTime(h.createdAt) }),
            h.notes && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9px] text-muted-foreground", children: [
              "— ",
              h.notes
            ] })
          ] }, h.id)),
          (!selectedShipment.history || selectedShipment.history.length === 0) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground", children: t("shipments.no_history") })
        ] })
      ] })
    ] }) }),
    deleteTarget && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50", onClick: () => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-semibold text-muted-foreground mt-3", children: t("shipments.delete_desc").replace("{destination}", deleteTarget.destination) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mt-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "destructive", className: "flex-1 h-11 text-[10px] font-black uppercase tracking-widest", onClick: handleDelete, children: t("shipments.delete") }),
