import { c as createLucideIcon, r as reactExports, aD as useComposedRefs, ad as useDirection, j as jsxRuntimeExports, a9 as Primitive, aF as Presence, af as createContextScope, aa as composeEventHandlers, aG as useCallbackRef, aH as useLayoutEffect2, k as cn, b as useSettings, m as useAuth, a5 as History, P as Package, K as Input, g as Badge, e as Button, aI as ChevronRight, T as TriangleAlert, t as toast } from "./index-BzfzhNvZ.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-D9rQjtzn.js";
import { C as Card, a as CardHeader, b as CardTitle, d as CardDescription, c as CardContent, L as Label } from "./label-DiH-WrI0.js";
import { e as clamp, S as Select, a as SelectTrigger, b as SelectValue, c as SelectContent, d as SelectItem } from "./select-CSULIuhp.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Root,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Corner, { "data-slot": "scroll-area-corner" })
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fade-in pb-24 relative min-h-screen bg-background text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 md:px-8 lg:px-12 max-w-[1600px] mx-auto flex flex-col gap-y-8 pt-8", children: [
              ...
              history.filter((h) => h.itemName.toLowerCase().includes(searchQuery.toLowerCase())).map((h, i) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border hover:bg-muted/30 transition-colors", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "px-6 py-4 font-medium whitespace-nowrap text-foreground", children: [
                    formatDate(h.date),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-muted-foreground", children: formatTime(h.createdAt) })
                  ] }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-6 py-4 text-center", children: h.reversalId ? /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "bg-muted/50 text-muted-foreground border-border font-bold text-[10px]", children: "Reversed" }) : hasPermission("adjustments.reverse") ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      variant: "ghost",
                      size: "sm",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialog, { open: reverseTarget !== null, onOpenChange: (open) => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AlertDialogTitle, { children: "Reverse Adjustment" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(AlertDialogDescription, { children: [
          "Are you sure you want to reverse this adjustment for ",
          reverseTarget?.itemName,
          "?"
        ] })
      ] }),
