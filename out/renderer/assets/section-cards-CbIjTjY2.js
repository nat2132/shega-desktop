import { j as jsxRuntimeExports, Y as motion, m as Badge, aG as TrendingDown } from "./index-wvHtiMql.js";
import { C as Card, a as CardHeader, d as CardDescription, b as CardTitle, e as CardAction, f as CardFooter } from "./card-BnskyD18.js";
...
function SectionCards({ cards, storageKey }) {
  if (!storageKey) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(KpiGrid, { cards });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(KpiVisibility, { storageKey, children: (visible) => visible ? /* @__PURE__ */ jsxRuntimeExports.jsx(KpiGrid, { cards }) : null });
}
export {
  SectionCards as S
};
