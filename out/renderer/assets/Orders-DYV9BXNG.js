import { b as useSettings, n as useAuth, d as useNavigate, r as reactExports, j as jsxRuntimeExports, e as Button, a9 as Search, V as Input, z as Sheet, D as SheetTrigger, F as Filter, g as Badge, G as SheetContent, H as SheetHeader, J as SheetTitle, K as SheetDescription, N as SheetFooter, O as SheetClose, b1 as DropdownMenu, b2 as DropdownMenuTrigger, b3 as DropdownMenuContent, b5 as DropdownMenuItem, A as ArrowRight, b9 as DropdownMenuSeparator, ae as CreditCard, P as PiggyBank, M as Modal, X, _ as toast } from "./index-fMHJoXSU.js";
import { S as SectionCards } from "./section-cards-Bqgbso3Z.js";
import { L as Label } from "./label-Ci33H1TS.js";
import { T as Textarea } from "./textarea-D_beCXqf.js";
...
import { E as Ellipsis } from "./ellipsis-C-g7LzQG.js";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 py-4 md:gap-6 md:py-6 fade-in", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open: isFilterOpen, onOpenChange: setIsFilterOpen, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "right", className: "w-[400px] sm:w-[540px] border-l-border/40 p-0 flex flex-col", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetHeader, { className: "border-b border-border/50 p-6", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(SheetDescription, { className: "text-xs font-bold text-muted-foreground uppercase tracking-widest", children: t("orders.filter_desc") })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 p-6 flex-1 overflow-y-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-black uppercase tracking-[0.3em] text-primary", children: t("orders.status") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { className: "text-sm", children: [
          filteredOrders.map((order) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t border-border/40 hover:bg-muted/20 transition-colors cursor-pointer", onClick: () => navigate(`/orders/${order.id}`), children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-5 py-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
              ...
              order.customerPhone && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: order.customerPhone })
            ] }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showCreateModal, onClose: () => {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground", children: t("orders.customer_name") }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground", children: t("orders.customer_phone") }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground", children: t("orders.notes") }),
