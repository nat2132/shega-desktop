import { c as createLucideIcon, b as useSettings, d as useNavigate, by as useLocation, bz as useSubscription, r as reactExports, j as jsxRuntimeExports, L as LoaderCircle, bA as PremiumBadge, e as Button, R as RefreshCw, S as Sparkles, aY as Crown, aq as Shield, h as Clock, A as ArrowRight, T as TriangleAlert, ad as CreditCard, bB as CircleHelp, g as Badge, C as CircleCheck, bC as Hourglass } from "./index-DQvMvM6p.js";
import { C as Card, c as CardContent, a as CardHeader, b as CardTitle } from "./card-MD6aRxed.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-DSqMyoyu.js";
import { C as Calendar } from "./calendar-CLih6_Mx.js";
...
const SubscriptionDashboard = () => {
  ...
  const statusBadge = (status) => {
    ...
    const Icon = v.icon;
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: `text-[9px] font-black uppercase tracking-widest ${v.color}`, children: [
  ...
  if (loading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-full py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("subscription.loading") })
    ] }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 p-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-semibold uppercase tracking-widest text-muted-foreground", children: t("subscription.subtitle") })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, className: "space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { className: "rounded-2xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "overview", className: "text-[10px] font-black uppercase tracking-widest rounded-xl", children: t("subscription.current_plan") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "plans", className: "text-[10px] font-black uppercase tracking-widest rounded-xl", children: t("subscription.pricing") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "payments", className: "text-[10px] font-black uppercase tracking-widest rounded-xl", children: t("subscription.payment_history") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "history", className: "text-[10px] font-black uppercase tracking-widest rounded-xl", children: t("subscription.subscription_history") })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "overview", className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-4 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "rounded-2xl border-border/50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "p-4 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground flex items-center gap-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "rounded-2xl border-border/50", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 pt-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground ml-1", children: t("premium.days_remaining", { days: String(isTrial ? trialDaysLeft : daysRemaining) }) })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "rounded-2xl border-border/50", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "p-4 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "text-[9px] font-black uppercase tracking-widest text-muted-foreground flex items-center gap-1.5", children: [
        ...
        isTrial && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-2xl border-amber-500/20 bg-gradient-to-r from-amber-500/[0.04] to-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground mt-0.5", children: t("premium.trial_ends", { date: subscription?.trialEndsAt ? formatDate(subscription.trialEndsAt) : "--" }) })
            ] })
          ] }),
        ...
        daysRemaining <= 7 && daysRemaining > 0 && !isTrial && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-2xl border-red-500/20 bg-gradient-to-r from-red-500/[0.04] to-transparent", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground mt-0.5", children: t("subscription.renew_desc") })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-2xl border-border/50 cursor-pointer hover:bg-muted/30 transition-all", onClick: () => navigate("/subscription/payment"), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest", children: t("subscription.billing") }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-2xl border-border/50 cursor-pointer hover:bg-muted/30 transition-all", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4 flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest", children: t("subscription.support") }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-muted-foreground", children: "shega.tech/support" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "h-4 w-4 text-muted-foreground ml-auto" })
          ] }) })
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "plans", className: "space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("subscription.basic_plan") }),
          plans.filter((p) => p.tier === "basic").map((plan) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: `rounded-2xl border-border/50 transition-all ${isCurrent ? "ring-1 ring-primary/20" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: plan.name }),
                isCurrent && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[8px] font-black uppercase tracking-widest bg-emerald-500/10 text-emerald-500 border-emerald-500/20", children: t("subscription.current") })
              ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground mt-1", children: plan.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  onClick: () => navigate("/subscription/payment"),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-amber-500", children: t("subscription.premium_plan") }),
          ...
          plans.filter((p) => p.tier === "premium").map((plan) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: `rounded-2xl border-amber-500/20 bg-gradient-to-b from-amber-500/[0.02] to-transparent transition-all ${isCurrent ? "ring-1 ring-amber-500/30" : ""}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-amber-500", children: plan.name }),
                isCurrent ? /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-[8px] font-black uppercase tracking-widest bg-emerald-500/10 text-emerald-500 border-emerald-500/20", children: t("subscription.current") }) : /* @__PURE__ */ jsxRuntimeExports.jsx(PremiumBadge, { size: "sm" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-2xl font-black", children: [
                plan.price.toLocaleString(),
                " ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "payments", className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("subscription.transaction_history") }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              onClick: () => navigate("/subscription/payment"),
        ...
        transactions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-2xl border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-8 text-center", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("subscription.no_transactions") })
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest", children: tx.selectedPlan }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[9px] text-muted-foreground", children: [
                tx.transactionId,
                " · ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
            ...
            tx.adminNotes && tx.status === "rejected" && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[8px] text-red-400 mt-0.5", children: tx.adminNotes })
          ] })
        ] }, tx.id)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "history", className: "space-y-4", children: history.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "rounded-2xl border-border/50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-8 text-center", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-black uppercase tracking-widest text-muted-foreground", children: t("subscription.no_subscription_history") })
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-semibold", children: h.action.replace(/_/g, " ") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[9px] text-muted-foreground truncate", children: h.details })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[8px] text-muted-foreground shrink-0", children: formatDate(h.createdAt) })
      ] }, h.id)) }) })
    ] })
  ] });
};
