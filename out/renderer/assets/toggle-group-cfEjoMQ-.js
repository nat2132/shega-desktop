import { r as reactExports, af as useControllableState, j as jsxRuntimeExports, ag as Primitive, ah as composeEventHandlers, ai as Item, aj as createRovingFocusGroupScope, ak as useDirection, al as Root, am as createContextScope, an as cn, ao as cva } from "./index-DoaPTPLA.js";
import { af as Tooltip, ai as ResponsiveContainer } from "./CartesianChart-CT6-hPc6.js";
var NAME = "Toggle";
...
var ToggleGroup$1 = reactExports.forwardRef((props, forwardedRef) => {
...
var ToggleGroupImplSingle = reactExports.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
...
var ToggleGroupImplMultiple = reactExports.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
...
var ToggleGroupImpl = reactExports.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToggleGroup,
      disabled = false,
...
var ToggleGroupItem$1 = reactExports.forwardRef(
  (props, forwardedRef) => {
...
var ToggleGroupItemImpl = reactExports.forwardRef(
  (props, forwardedRef) => {
...
function ToggleGroup({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Root2,
    {
      ...
      ...props,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(ToggleGroupContext.Provider, { value: { variant, size, spacing }, children })
    }
  );
}
