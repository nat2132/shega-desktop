import { b as useSettings, j as jsxRuntimeExports, a0 as Dialog, a1 as DialogContent, a2 as DialogClose, X, a3 as DialogHeader, a4 as DialogTitle, a5 as DialogDescription, a6 as DialogFooter, e as Button, Z as Download, Y as ShoppingCart, r as reactExports, s as ShoppingBag, a7 as User, g as Badge, x as Eye, y as Trash2, z as Sheet, D as SheetTrigger, F as Filter, G as SheetContent, H as SheetHeader, J as SheetTitle, K as SheetDescription, N as SheetFooter, O as SheetClose, Q as FileText, M as Modal, a8 as React, a9 as Search, V as Input, _ as toast, $ as playSound } from "./index-D0em7kRt.js";
import { E, e as exportCSV, a as exportPDF } from "./export-utils-UNhTk_Ak.js";
...
const Sales = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-4 py-4 md:gap-6 md:py-6 fade-in", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 shrink-0", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                Select,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "h-7 w-20 text-xs font-black uppercase tracking-widest rounded-lg border-border/40 bg-card px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "base", className: "text-xs uppercase font-bold", children: t("sales.individual") }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "pack", className: "text-xs uppercase font-bold", children: t("sales.pack") })
                    ] })
                  ]
                }
              )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { isOpen: showReturnModal, onClose: () => setShowReturnModal(false), title: t("sales.process_return", "Process Return"), size: "sm", children: returnSale && /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleReturn, className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground", children: t("sales.return_reason_label", "Reason") }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            value: returnReason,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pt-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", className: "flex-1 h-9 text-xs font-bold tracking-widest", disabled: !returnQty || parseFloat(returnQty) < 1, children: t("sales.process_return", "Process Return") })
      ] })
    ] }) }),
